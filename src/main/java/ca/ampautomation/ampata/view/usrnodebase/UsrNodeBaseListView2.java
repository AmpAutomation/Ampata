...
@Route(value = "usrNodeBases2", layout = MainView.class)
@ViewController("enty_UsrNodeBase2.list")
@ViewDescriptor("usr-node-base-list-view2.xml")
@LookupComponent("usrNodeBasesDataGrid")
@DialogMode(width = "64em")
public class UsrNodeBaseListView2 extends StandardListView<UsrNodeBase> {
