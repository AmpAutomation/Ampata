...
@UiController("enty_UsrNodeFinBal.lookup")
@UiDescriptor("usr-node-fin-bal-0-lookup.xml")
@LookupComponent("tableMain")
public class UsrNodeFinBal0Lookup extends UsrNodeBase0BaseLookup<UsrNodeFinBal, UsrNodeFinBalType, UsrNodeFinBal0Service, UsrNodeFinBal0Repo, Table<UsrNodeFinBal>> {
