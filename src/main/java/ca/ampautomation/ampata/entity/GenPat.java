...
@JmixEntity
@Table(name = "AMPATA_GEN_PAT", indexes = {
        @Index(name = "IDX_GENPAT_TYPE1__ID", columnList = "TYPE1__ID")
})
...
public class GenPat  {
    ...
    @Transient
    protected Logger logger = LoggerFactory.getLogger(GenPat.class);
    ...
    public GenPatType getType1_Id() {
        return type1_Id;
    }

    public void setType1_Id(GenPatType type1_Id) {
