...
@Table(name = "AMPATA_SYS_NODE", indexes = {
        ...
        @Index(name = "IDX_SYSNODE_NAME1_SYS_PAT1__ID", columnList = "NAME1_SYS_PAT1__ID"),
        @Index(name = "IDX_SYSNODE_DESC1_SYS_PAT1__ID", columnList = "DESC1_SYS_PAT1__ID"),
        @Index(name = "IDX_SYSNODE_DESC1_FIN_TXACT_ITM1__ID", columnList = "DESC1_FIN_TXACT_ITM1__ID"),
        @Index(name = "IDX_SYSNODE_DESC1_FIN_TXACT_ITM2__ID", columnList = "DESC1_FIN_TXACT_ITM2__ID"),
        @Index(name = "IDX_SYSNODE_GEN_CHAN1__ID", columnList = "GEN_CHAN1__ID"),
        @Index(name = "IDX_SYSNODE_GEN_CHAN2__ID", columnList = "GEN_CHAN2__ID"),
        @Index(name = "IDX_SYSNODE_FIN_HOW1__ID", columnList = "FIN_HOW1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_WHAT1__ID", columnList = "FIN_WHAT1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_WHY1__ID", columnList = "FIN_WHY1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_TXSET1__ID", columnList = "FIN_TXSET1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_TXACT1__ID", columnList = "FIN_TXACT1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_ACCT1__ID", columnList = "FIN_ACCT1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_DEPT1__ID", columnList = "FIN_DEPT1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_STMT1__ID", columnList = "FIN_STMT1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_STMT_ITM1__ID", columnList = "FIN_STMT_ITM1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_BAL1__ID", columnList = "FIN_BAL1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_BAL_SET1__ID", columnList = "FIN_BAL_SET1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_TAX_LNE1__ID", columnList = "FIN_TAX_LNE1__ID"),
        @Index(name = "IDX_SYSNODE_FIN_CURCY1__ID", columnList = "FIN_CURCY1__ID"),
        @Index(name = "IDX_SYSNODE_AMT_FIN_FMLA1__ID", columnList = "AMT_FIN_FMLA1__ID"),
        @Index(name = "IDX_SYSNODE_AMT_FIN_TXACT_ITM1__ID", columnList = "AMT_FIN_TXACT_ITM1__ID"),
        @Index(name = "IDX_SYSNODE_GEN_DOC_VER1__ID", columnList = "GEN_DOC_VER1__ID"),
        @Index(name = "IDX_SYSNODE_GEN_FILE1__ID", columnList = "GEN_FILE1__ID"),
        @Index(name = "IDX_SYSNODE_GEN_TAG1__ID", columnList = "GEN_TAG1__ID"),
        @Index(name = "IDX_SYSNODE_GEN_TAG2__ID", columnList = "GEN_TAG2__ID"),
        @Index(name = "IDX_SYSNODE_GEN_TAG3__ID", columnList = "GEN_TAG3__ID"),
        @Index(name = "IDX_SYSNODE_GEN_TAG4__ID", columnList = "GEN_TAG4__ID"),
        @Index(name = "IDX_SYSNODE_GEN_AGENT1__ID", columnList = "GEN_AGENT1__ID"),
        @Index(name = "IDX_SYSNODE_GEN_AGENT2__ID", columnList = "GEN_AGENT2__ID")
})
...
@NamedStoredProcedureQueries({
        ...
        @NamedStoredProcedureQuery(name = "SysNode.execSysNodePrUpd",
                procedureName = "Sys_Node_Pr_Upd", parameters = {

        }),

        @NamedStoredProcedureQuery(name = "SysNode.execSysNodePrUpd2",
                procedureName = "Sys_Node_Pr_Upd2"
                , parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "inParam1", type = String.class)
        }),

        @NamedStoredProcedureQuery(name = "SysNode.execSysNodePrUpd3",
                procedureName = "Sys_Node_Pr_Upd3"
                , parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "inParam1", type = String.class)
                , @StoredProcedureParameter(mode = ParameterMode.OUT, name = "outParam1", type = String.class)
        }),

        @NamedStoredProcedureQuery(name = "SysNode.execFinTxactItmPrUpd",
                procedureName = "Fin_Txact_Itm_Pr_Upd", parameters = {

        }),

        @NamedStoredProcedureQuery(name = "SysNode.execFinTxactItmPrUpd2",
...
public class SysNode implements AcceptsTenant {
    @JmixGeneratedValue
    ...
    @JoinColumn(name = "NAME1_SYS_PAT1__ID")
    @ManyToOne(fetch = FetchType.LAZY)
    private SysPat name1SysPat1_Id;

    @Column(name = "NAME1_SYS_PAT1__ID2")
    private String name1SysPat1_Id2;
    ...
    @JoinColumn(name = "DESC1_SYS_PAT1__ID")
    @ManyToOne(fetch = FetchType.LAZY)
    private SysPat desc1SysPat1_Id;

    @Column(name = "DESC1_SYS_PAT1__ID2")
    private String desc1SysPat1_Id2;

    @JoinColumn(name = "DESC1_FIN_TXACT_ITM1__ID")
    @ManyToOne(fetch = FetchType.LAZY)
    private SysNode desc1FinTxactItm1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private SysNode desc1FinTxactItm2_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private SysNode finStmtItm1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private SysNode amtFinTxactItm1_Id;
...
*/
    ...
    @Transient
    private final Logger logger = LoggerFactory.getLogger(SysNode.class);
    ...
    public SysPat getName1SysPat1_Id() {
        return name1SysPat1_Id;
    }

    public void setName1SysPat1_Id(SysPat name1SysPat1_Id) {
        this.name1SysPat1_Id = name1SysPat1_Id;
    }

    public String getName1SysPat1_Id2() {
        return name1SysPat1_Id2;
    }

    public void setName1SysPat1_Id2(String name1SysPat1_Id2) {
        this.name1SysPat1_Id2 = name1SysPat1_Id2;
    }
    ...
    public SysPat getDesc1SysPat1_Id() {
        return desc1SysPat1_Id;
    }

    public void setDesc1SysPat1_Id(SysPat desc1SysPat1_Id) {
        this.desc1SysPat1_Id = desc1SysPat1_Id;
    }

    public String getDesc1SysPat1_Id2() {
        return desc1SysPat1_Id2;
    }

    public void setDesc1SysPat1_Id2(String desc1SysPat1_Id2) {
        this.desc1SysPat1_Id2 = desc1SysPat1_Id2;
    }


    public SysNode getDesc1FinTxactItm1_Id() {
        return desc1FinTxactItm1_Id;
    }

    public void setDesc1FinTxactItm1_Id(SysNode desc1FinTxactItm1_Id) { this.desc1FinTxactItm1_Id = desc1FinTxactItm1_Id; }
    ...
    public SysNode getDesc1FinTxactItm2_Id() { return desc1FinTxactItm2_Id; }

    public void setDesc1FinTxactItm2_Id(SysNode desc1FinTxactItm2_Id) { this.desc1FinTxactItm2_Id = desc1FinTxactItm2_Id; }
    ...
    public SysNode getGenChan1_Id() {
        return genChan1_Id;
    }

    public void setGenChan1_Id(SysNode genChan1_Id) {
    ...
    public SysNode getGenChan2_Id() {return genChan2_Id;}

    public void setGenChan2_Id(SysNode genChan2_Id) {this.genChan2_Id = genChan2_Id;}
...
*/
    ...
    public SysNode getGenDocVer1_Id() {
        return genDocVer1_Id;
    }

    public void setGenDocVer1_Id(SysNode genDocVer1_Id) {
    ...
    public SysNode getGenFile1_Id() {
        return genFile1_Id;
    }

    public void setGenFile1_Id(SysNode genFile1_Id) {
    ...
    public SysNode getGenTag1_Id() {
        return genTag1_Id;
    }

    public void setGenTag1_Id(SysNode genTag1_Id) {
    ...
    public SysNode getGenTag2_Id() {
        return genTag2_Id;
    }

    public void setGenTag2_Id(SysNode genTag2_Id) {
    ...
    public SysNode getGenTag3_Id() {
        return genTag3_Id;
    }

    public void setGenTag3_Id(SysNode genTag3_Id) {
    ...
    public SysNode getGenTag4_Id() {
        return genTag4_Id;
    }

    public void setGenTag4_Id(SysNode genTag4_Id) {
    ...
    public SysNode getGenAgent1_Id() {
        return genAgent1_Id;
    }

    public void setGenAgent1_Id(SysNode genAgent1_Id) {
    ...
    public SysNode getGenAgent2_Id() {
        return genAgent2_Id;
    }

    public void setGenAgent2_Id(SysNode genAgent2_Id) {
    ...
    public SysNode getFinTxset1_Id() {
        return finTxset1_Id;
    }

    public void setFinTxset1_Id(SysNode finTxset1_Id) {
    ...
    public SysNode getFinTxact1_Id() {
        return finTxact1_Id;
    }

    public void setFinTxact1_Id(SysNode finTxact1_Id) {
    ...
    public SysNode getFinStmt1_Id() {
        return finStmt1_Id;
    }

    public void setFinStmt1_Id(SysNode finStmt1_Id) {
    ...
    public SysNode getFinStmtItm1_Id() {
        return finStmtItm1_Id;
    }

    public void setFinStmtItm1_Id(SysNode finStmtItm1_Id) {
    ...
    public SysNode getFinAcct1_Id() { return finAcct1_Id; }

    public void setFinAcct1_Id(SysNode finAcct1_Id) {
    ...
    public SysNode getFinDept1_Id() {
        return finDept1_Id;
    }

    public void setFinDept1_Id(SysNode finDept1_Id) {
    ...
    public SysNode getFinCurcy1_Id() {
        return finCurcy1_Id;
    }

    public void setFinCurcy1_Id(SysNode finCurcy1_Id) {
    ...
    public SysNode getFinTaxLne1_Id() {
        return finTaxLne1_Id;
    }

    public void setFinTaxLne1_Id(SysNode finTaxLne1_Id) {
    ...
    public SysNode getAmtFinTxactItm1_Id() {
        return amtFinTxactItm1_Id;
    }

    public void setAmtFinTxactItm1_Id(SysNode amtFinTxactItm1_Id) {
    ...
    public SysNode getFinBal1_Id() { return finBal1_Id; }

    public void setFinBal1_Id(SysNode finTax_1_Id) { this.finBal1_Id = finTax_1_Id; }
    ...
    public SysNode getFinBalSet1_Id() { return finBalSet1_Id; }

    public void setFinBalSet1_Id(SysNode finTax_1_Id) { this.finBalSet1_Id = finTax_1_Id; }
...
//                        || beg2.getTs1() == null
    ...
    public Boolean updateGenAgent1(){
        ...
        SysNode genAgent1_ = getGenAgent1_Id();
        SysNode genAgent1 = null;
        ...
        switch (className) {
            case "FinAcct" -> {
                ...
                genAgent1 = findSysNodeById2(genAgent1_Id2, "FinAcct");
                if (genAgent1 == null) {
                    logger.trace(logPrfx + " <-- ");
                    return isChanged;
                }
    ...
    public SysNode findSysNodeById2(@NotNull String SysNode_Id2, @NotNull String className) {
        String logPrfx = "findSysNodeById2";
        logger.trace(logPrfx + " --> ");

        String qry = "select e from ampata_SysNode e where e.className = :className and e.id2 = :id2";
        logger.debug(logPrfx + " --- qry: " + qry);
        logger.debug(logPrfx + " --- qry:id2: " + SysNode_Id2);

        SysNode sysNode1_Id = null;
        try {
/*
            sysNode1_Id = dataManager.load(SysNode.class)
                    .query(qry)
                    .parameter("className", className)
                    .parameter("id2", SysNode_Id2)
                    .one();
