...
import ca.ampautomation.ampata.entity.usr.node.fin.UsrFinStmtItm;
...
@NamedStoredProcedureQueries({
        ...
        @NamedStoredProcedureQuery(name = "UsrNodeBase.execUsrFinTxactItmPrUpd",
                procedureName = "Fin_Txact_Itm_Pr_Upd", parameters = {

        }),

        @NamedStoredProcedureQuery(name = "UsrNodeBase.execUsrFinTxactItmPrUpd2",
...
public class UsrNodeBase implements AcceptsTenant {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysNodeBase sysFinCurcy1_Id;
    ...
    public SysNodeBase getSysFinCurcy1_Id() { return sysFinCurcy1_Id; }

    public void setSysFinCurcy1_Id(SysNodeBase sysFinCurcy1_Id) { this.sysFinCurcy1_Id = sysFinCurcy1_Id; }
