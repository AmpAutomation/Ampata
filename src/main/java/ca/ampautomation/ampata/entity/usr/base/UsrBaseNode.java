...
@Entity(name = "enty_UsrBaseNode")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
@NamedStoredProcedureQueries({

        @NamedStoredProcedureQuery(name = "UsrBaseNode.execUsrBaseNodePrUpd",
                procedureName = "Usr_Node_Pr_Upd", parameters = {

        }),

        @NamedStoredProcedureQuery(name = "UsrBaseNode.execUsrBaseNodePrUpd2",
                procedureName = "Usr_Node_Pr_Upd2"
                , parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "inParam1", type = String.class)
        }),

        @NamedStoredProcedureQuery(name = "UsrBaseNode.execUsrBaseNodePrUpd3",
        ...
        @NamedStoredProcedureQuery(name = "UsrBaseNode.execUsrFinTxactItmPrUpd",
                procedureName = "Fin_Txact_Itm_Pr_Upd", parameters = {

        }),

        @NamedStoredProcedureQuery(name = "UsrBaseNode.execUsrFinTxactItmPrUpd2",
...
public class UsrBaseNode implements AcceptsTenant {
    ...
    protected UsrBaseNode parent1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNodeType type1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNodeType nm1s1Type1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode nm1s1Inst1Node1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode desc1Node1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode desc1Node2_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finTxactSet1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finTxact1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finStmt1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrFinStmtItm finStmtItm1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finAcct1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finDept1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finTaxLne1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysBaseNode sysFinCurcy1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode amtFinTxactItm1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finBal1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrBaseNode finBalSet1_Id;
    ...
    public UsrBaseNode getParent1_Id() { return parent1_Id; }

    public void setParent1_Id(UsrBaseNode parent1_Id) { this.parent1_Id = parent1_Id; }
    ...
    public void setType1_Id(UsrBaseNodeType type1_Id) { this.type1_Id = type1_Id; }

    public UsrBaseNodeType getType1_Id() { return type1_Id; }
    ...
    public UsrBaseNodeType getNm1s1Type1_Id() { return nm1s1Type1_Id; }

    public void setNm1s1Type1_Id(UsrBaseNodeType nm1s1Type1_Id) { this.nm1s1Type1_Id = nm1s1Type1_Id; }
    ...
    public UsrBaseNode getNm1s1Inst1Node1_Id() { return nm1s1Inst1Node1_Id; }

    public void setNm1s1Inst1Node1_Id(UsrBaseNode nm1s1Inst1Node1_Id) { this.nm1s1Inst1Node1_Id = nm1s1Inst1Node1_Id; }
    ...
    public UsrBaseNode getDesc1Node1_Id() { return desc1Node1_Id; }

    public void setDesc1Node1_Id(UsrBaseNode desc1Node1_Id) { this.desc1Node1_Id = desc1Node1_Id; }
    ...
    public UsrBaseNode getDesc1Node2_Id() { return desc1Node2_Id; }

    public void setDesc1Node2_Id(UsrBaseNode desc1Node2_Id) { this.desc1Node2_Id = desc1Node2_Id; }
    ...
    public List<UsrBaseEdge> getEdgeIns_Id() {
        return edgeIns_Id;
    }

    public void setEdgeIns_Id(List<UsrBaseEdge> edgeIns_Id) {
    ...
    public List<UsrBaseEdge> getEdgeOts_Id() {
        return edgeOts_Id;
    }

    public void setEdgeOts_Id(List<UsrBaseEdge> edgeOts_Id) {
    ...
    public UsrBaseNode getFinTxactSet1_Id() { return finTxactSet1_Id; }

    public void setFinTxactSet1_Id(UsrBaseNode finTxactSet1_Id) { this.finTxactSet1_Id = finTxactSet1_Id; }
    ...
    public UsrBaseNode getFinTxact1_Id() {return finTxact1_Id; }

    public void setFinTxact1_Id(UsrBaseNode finTxact1_Id) { this.finTxact1_Id = finTxact1_Id; }
    ...
    public UsrBaseNode getFinStmt1_Id() { return finStmt1_Id; }

    public void setFinStmt1_Id(UsrBaseNode finStmt1_Id) { this.finStmt1_Id = finStmt1_Id; }
    ...
    public UsrFinStmtItm getFinStmtItm1_Id() { return finStmtItm1_Id; }

    public void setFinStmtItm1_Id(UsrFinStmtItm finStmtItm1_Id) { this.finStmtItm1_Id = finStmtItm1_Id; }
    ...
    public UsrBaseNode getFinAcct1_Id() { return finAcct1_Id; }

    public void setFinAcct1_Id(UsrBaseNode finAcct1_Id) { this.finAcct1_Id = finAcct1_Id; }
    ...
    public UsrBaseNode getFinDept1_Id() { return finDept1_Id; }

    public void setFinDept1_Id(UsrBaseNode finDept1_Id) { this.finDept1_Id = finDept1_Id; }
    ...
    public SysBaseNode getSysFinCurcy1_Id() { return sysFinCurcy1_Id; }

    public void setSysFinCurcy1_Id(SysBaseNode sysFinCurcy1_Id) { this.sysFinCurcy1_Id = sysFinCurcy1_Id; }
    ...
    public UsrBaseNode getFinTaxLne1_Id() { return finTaxLne1_Id; }

    public void setFinTaxLne1_Id(UsrBaseNode finTaxLne1_Id) { this.finTaxLne1_Id = finTaxLne1_Id; }
    ...
    public UsrBaseNode getAmtFinTxactItm1_Id() { return amtFinTxactItm1_Id; }

    public void setAmtFinTxactItm1_Id(UsrBaseNode amtFinTxactItm1_Id) { this.amtFinTxactItm1_Id = amtFinTxactItm1_Id; }
    ...
    public UsrBaseNode getFinBal1_Id() { return finBal1_Id; }

    public void setFinBal1_Id(UsrBaseNode finTax_1_Id) { this.finBal1_Id = finTax_1_Id; }
    ...
    public UsrBaseNode getFinBalSet1_Id() { return finBalSet1_Id; }

    public void setFinBalSet1_Id(UsrBaseNode finTax_1_Id) { this.finBalSet1_Id = finTax_1_Id; }
...
//                        || ts2.getElTs() == null
    ...
    public Boolean updateGenAgent1(){
        ...
        UsrBaseNode l_genAgent1_ = getGenAgent1_Id();
        UsrBaseNode l_genAgent1 = null;
    ...
    public static <NodeT extends UsrBaseNode> NodeT getNodeById2(Class<NodeT> type, DataManager dataManager, @NotNull String crtieria_Id2) {
        final Logger logger = LoggerFactory.getLogger(UsrBaseNode.class.getClass());
    ...
    public static <NodeT extends UsrBaseNode> NodeT getNodesBySortIdx(Class<NodeT> type, DataManager dataManager, @NotNull Integer sortIdx, UsrBaseNode parent1_Id) {
        final Logger logger = LoggerFactory.getLogger(UsrBaseNode.class.getClass());
    ...
    public static <NodeT extends UsrBaseNode>  List<NodeT> getNodesBtwnSortIdx(Class<NodeT> type, DataManager dataManager, @NotNull Integer sortIdxA , @NotNull Integer sortIdxB, UsrBaseNode parent1_Id) {
        final Logger logger = LoggerFactory.getLogger(UsrBaseNode.class.getClass());
    ...
    public static <NodeT extends UsrBaseNode> List<NodeT> getNodesByParent1(Class<NodeT> type, DataManager dataManager, UsrBaseNode parent1_Id) {
        final Logger logger = LoggerFactory.getLogger(UsrBaseNode.class.getClass());
    ...
    public static <NodeT extends UsrBaseNode> List<String> getStatusList(Class<NodeT> type, DataManager dataManager){
        final Logger logger = LoggerFactory.getLogger(UsrBaseNode.class.getClass());
