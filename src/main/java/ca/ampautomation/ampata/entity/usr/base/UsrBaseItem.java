...
@Entity(name = "enty_UsrBaseItem")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class UsrBaseItem implements AcceptsTenant {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private UsrBaseItemType type1_Id;
    ...
    public UsrBaseItemType getType1_Id() {
        return type1_Id;
    }

    public void setType1_Id(UsrBaseItemType type1_Id) {
