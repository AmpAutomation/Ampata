...
@Entity(name = "enty_UsrEdge")
public class UsrEdge implements AcceptsTenant {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected UsrEdgeType type1_Id;
    ...
    public void setType1_Id(UsrEdgeType type1_Id) { this.type1_Id = type1_Id; }

    public UsrEdgeType getType1_Id() { return type1_Id; }
    ...
    public UsrNode getNodeIn_Id() { return nodeIn_Id; }

    public void setNodeIn_Id(UsrNode nodeIn_Id) { this.nodeIn_Id = nodeIn_Id; }
    ...
    public UsrNode getNodeOt_Id() { return nodeOt_Id; }

    public void setNodeOt_Id(UsrNode nodeOt_Id) { this.nodeOt_Id = nodeOt_Id; }
