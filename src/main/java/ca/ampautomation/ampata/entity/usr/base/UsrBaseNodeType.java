...
@Entity(name = "enty_UsrBaseNodeType")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class UsrBaseNodeType implements AcceptsTenant {
    ...
    private UsrBaseNodeType parent1_Id;
    ...
    public UsrBaseNodeType getParent1_Id() {
        return parent1_Id;
    }

    public void setParent1_Id(UsrBaseNodeType parent1_Id) {
