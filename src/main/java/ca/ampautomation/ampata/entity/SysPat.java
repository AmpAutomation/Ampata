...
@JmixEntity
@Table(name = "AMPATA_SYS_PAT", indexes = {
        @Index(name = "IDX_SYSPAT_TYPE1__ID", columnList = "TYPE1__ID")
})

@Entity(name = "ampata_SysPat")
public class SysPat {
    @JmixGeneratedValue
    ...
    @Transient
    protected Logger logger = LoggerFactory.getLogger(SysPat.class);
    ...
    public SysPatType getType1_Id() {
        return type1_Id;
    }

    public void setType1_Id(SysPatType type1_Id) {
