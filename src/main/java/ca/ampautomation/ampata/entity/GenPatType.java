...
@JmixEntity
@Table(name = "AMPATA_GEN_PAT_TYPE", indexes = {
        @Index(name = "IDX_GENPAT_PARENT1__ID", columnList = "PARENT1__ID")
})

@Entity(name = "ampata_GenPatType")
public class GenPatType {
    @JmixGeneratedValue
    ...
    public GenPatType getParent1_Id() {
        return parent1_Id;
    }

    public void setParent1_Id(GenPatType parent1_Id) {
