...
@Entity(name = "enty_SysNodeBaseType")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class SysNodeBaseType {
    ...
    private SysNodeBaseType parent1_Id;
    ...
    private SysItemGenFmla name1GenFmla1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private SysItemGenFmla desc1GenFmla1_Id;
    ...
    public SysNodeBaseType getParent1_Id() {
        return parent1_Id;
    }

    public void setParent1_Id(SysNodeBaseType parent1_Id) {
