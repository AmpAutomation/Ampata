...
@Entity(name = "enty_SysBaseNodeType")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class SysBaseNodeType {
    ...
    private SysBaseNodeType parent1_Id;
    ...
    public SysBaseNodeType getParent1_Id() {
        return parent1_Id;
    }

    public void setParent1_Id(SysBaseNodeType parent1_Id) {
