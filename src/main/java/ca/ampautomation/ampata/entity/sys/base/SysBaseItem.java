...
@Entity(name = "enty_SysBaseItem")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class SysBaseItem {
    ...
    private SysBaseItemType type1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private SysBaseItem name1GenFmla1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private SysBaseItem desc1GenFmla1_Id;
    ...
    public SysBaseItemType getType1_Id() { return type1_Id; }

    public void setType1_Id(SysBaseItemType type1_Id) { this.type1_Id = type1_Id; }
    ...
    public SysBaseItem getName1GenFmla1_Id() { return name1GenFmla1_Id; }

    public void setName1GenFmla1_Id(SysBaseItem name1GenFmla1_Id) { this.name1GenFmla1_Id = name1GenFmla1_Id; }
    ...
    public SysBaseItem getDesc1GenFmla1_Id() { return desc1GenFmla1_Id; }

    public void setDesc1GenFmla1_Id(SysBaseItem desc1GenFmla1_Id) { this.desc1GenFmla1_Id = desc1GenFmla1_Id; }
