package ca.ampautomation.ampata.entity.sys.node.base;
...
@Entity(name = "enty_SysNodeBase")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class SysNodeBase {
    ...
    protected SysNodeBase parent1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysItemGenFmla name1GenFmla1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysNodeBaseType type1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysItemGenFmla nm1s1Name1GenFmla1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysNodeBaseType nm1s1Type1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysItemGenFmla nm1s1Inst1GenFmla1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysItemGenFmla desc1GenFmla1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysNodeFinCurcy finCurcy1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysNodeFinCurcy finCurcy2_Id;
    ...
    public SysNodeBase getParent1_Id() {
        return parent1_Id;
    }

    public void setParent1_Id(SysNodeBase parent1_Id) {
    ...
    public SysItemGenFmla getName1GenFmla1_Id() { return name1GenFmla1_Id; }

    public void setName1GenFmla1_Id(SysItemGenFmla name1GenFmla1_Id) { this.name1GenFmla1_Id = name1GenFmla1_Id; }
    ...
    public SysNodeBaseType getNm1s1Type1_Id() {
        return nm1s1Type1_Id;
    }

    public void setNm1s1Type1_Id(SysNodeBaseType nm1s1Type1_Id) {
    ...
    public SysItemGenFmla getNm1s1Name1GenFmla1_Id() { return nm1s1Name1GenFmla1_Id; }

    public void setNm1s1Name1GenFmla1_Id(SysItemGenFmla nm1s1Name1GenFmla1_Id) { this.nm1s1Name1GenFmla1_Id = nm1s1Name1GenFmla1_Id; }
    ...
    public SysItemGenFmla getNm1s1Inst1GenFmla1_Id() { return nm1s1Inst1GenFmla1_Id; }

    public void setNm1s1Inst1GenFmla1_Id(SysItemGenFmla nm1s1Inst1GenFmla1_Id) { this.nm1s1Inst1GenFmla1_Id = nm1s1Inst1GenFmla1_Id; }
    ...
    public SysItemGenFmla getDesc1GenFmla1_Id() { return desc1GenFmla1_Id; }

    public void setDesc1GenFmla1_Id(SysItemGenFmla desc1GenFmla1_Id) { this.desc1GenFmla1_Id = desc1GenFmla1_Id; }
