...
@Entity(name = "enty_SysBaseNode")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "DTYPE", discriminatorType = DiscriminatorType.STRING)
public class SysBaseNode {
    ...
    protected SysBaseNode parent1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysBaseNodeType type1_Id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    protected SysBaseNodeType nm1s1Type1_Id;
    ...
    public SysBaseNode getParent1_Id() {
        return parent1_Id;
    }

    public void setParent1_Id(SysBaseNode parent1_Id) {
    ...
    public void setType1_Id(SysBaseNodeType type1_Id) {
        this.type1_Id = type1_Id;
    }

    public SysBaseNodeType getType1_Id() {
        return type1_Id;
    }
    ...
    public SysBaseNodeType getNm1s1Type1_Id() {
        return nm1s1Type1_Id;
    }

    public void setNm1s1Type1_Id(SysBaseNodeType nm1s1Type1_Id) {
    ...
    public SysBaseNode getFinCurcy1_Id() { return finCurcy1_Id; }
    ...
    public SysBaseNode getFinCurcy2_Id() { return finCurcy2_Id; }
