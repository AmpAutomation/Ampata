...
@Repository("bean_UsrEdgeBaseType.Repo")
public class UsrEdgeBase0Type0Repo<T, Id extends Serializable>
        implements UsrEdgeBase0Type0RepoIntfc<T, Id> {
