...
@Repository("bean_SysNodeBase.Repo")
public class SysNodeBase0Type0Repo<T, Id extends Serializable>
        implements SysNodeBase0Type0RepoIntfc<T, Id> {
