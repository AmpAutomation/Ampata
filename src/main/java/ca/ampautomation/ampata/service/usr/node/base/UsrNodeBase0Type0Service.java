...
@Component("bean_UsrNodeBase0TypeService")
public class UsrNodeBase0Type0Service implements Globals {
    ...
    public UsrNodeBase0Type0Service() {
        this.typeOfNodeType = UsrNodeBaseType.class;
    }
    ...
    public Boolean updateSortKey(@NotNull Screen screen, @NotNull UsrNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                Optional<String> o_parent1_SortKey = Optional.ofNullable(thisNodeType.getParent1_Id()).map(UsrNodeBaseType::getSortKey);
                Optional<UsrNodeBaseType> o_parent1_Id = Optional.ofNullable(thisNodeType.getParent1_Id());
