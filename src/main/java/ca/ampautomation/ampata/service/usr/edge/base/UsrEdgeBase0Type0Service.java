...
@Component("bean_UsrEdgeBase0TypeService")
public class UsrEdgeBase0Type0Service implements Globals {

    @Transient
    protected final Logger logger = LoggerFactory.getLogger(this.getClass());

    protected Class typeOfEdgeType;

    public UsrEdgeBase0Type0Service() {
        this.typeOfEdgeType = UsrEdgeBaseType.class;
    }
     ...
     */
    public Boolean updateCalcVals(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption){
        String logPrfx = "updateCalcVals";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;

        isChanged = updateName1(screen, thisEdgeType, updOption) || isChanged;

        isChanged = updateId2Calc(screen, thisEdgeType, updOption) || isChanged;
        isChanged = updateId2Cmp(screen, thisEdgeType, updOption) || isChanged;
        isChanged = updateId2Dup(screen, thisEdgeType, updOption) || isChanged;
        isChanged = updateSortKey(screen, thisEdgeType, updOption) || isChanged;
     ...
     */
    public Boolean updateId2(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                String id2_ = thisEdgeType.getId2();
                String id2 = thisEdgeType.getId2Calc();
                logger.debug(logPrfx + " --- id2:" + id2);

                if(Objects.equals(id2_, id2)) {
                    logger.debug(logPrfx + " --- no change detected");
                }else{
                    thisEdgeType.setId2(id2);
                    logger.debug(logPrfx + " --- called thisEdgeType.setId2(id2)");
                    isChanged = true;
                }
            }
        }
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateId2Deps(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        String logPrfx = "updateId2Deps";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;

        isChanged = this.updateId2Cmp(screen, thisEdgeType, updOption) || isChanged;
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Calc(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                //name1 required
                Optional<String> o_name1 = Optional.ofNullable(thisEdgeType.getName1());
                if(o_name1.isEmpty()) {
                ...
                String id2Calc_ = thisEdgeType.getId2Calc();
                ...
                if (Objects.equals(id2Calc_, id2Calc)) {
                    ...
                    thisEdgeType.setId2Calc(id2Calc);
                    logger.debug(logPrfx + " --- called thisEdgeType.setId2Calc(id2Calc)");
                    isChanged = true;
                }
            }
        }
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2CalcDeps(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Cmp(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        String logPrfx = "updateId2Cmp";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;
        Boolean id2Cmp_ = thisEdgeType.getId2Cmp();
        Boolean id2Cmp = !Objects.equals(thisEdgeType.getId2(),thisEdgeType.getId2Calc());
        logger.debug(logPrfx + " --- id2Cmp:" + id2Cmp);

        if (Objects.equals(id2Cmp_, id2Cmp)) {
            logger.debug(logPrfx + " --- no change detected");
        }else{
            thisEdgeType.setId2Cmp(id2Cmp);
            logger.debug(logPrfx + " --- called thisEdgeType.setId2Cmp(id2Cmp)");
            isChanged = true;
        }
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Dup(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                    ...
                    ,LOCAL__REF_IF_EMPTY_TO_EXIST_NEW
                    -> {
                Integer id2Dup_ = thisEdgeType.getId2Dup();
                Integer id2Dup;
                if (thisEdgeType.getId2() != null){
                    String id2Qry = "select count(e)"
                            + " from enty_" + thisEdgeType.getClass().getSimpleName() + " e"
                            + " where e.id2 = :id2"
                            + " and e.id <> :id";
                    try{
                        id2Dup = this.dataManager.loadValue(id2Qry, Integer.class)
                                .store("main")
                                .parameter("id",thisEdgeType.getId())
                                .parameter("id2",thisEdgeType.getId2())
                                .one();
                    ...
                    if (Objects.equals(id2Dup_, id2Dup)) {
                        ...
                        thisEdgeType.setId2Dup(id2Dup);
                        logger.debug(logPrfx + " --- called thisEdgeType.setId2Cmp(l_id2Cmp_)");
                        isChanged = true;
                    }
                }
            }
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateSortIdxDeps(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateId2DupDeps(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateSortKey(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                //sortIdx optional
                Optional<Integer> o_sortIdx = Optional.ofNullable(thisEdgeType.getSortIdx());
                ...
                String sortKey_ = thisEdgeType.getSortKey();
                String sortKey;
                ...
                if (Objects.equals(sortKey_, sortKey)) {
                    ...
                    thisEdgeType.setSortKey(sortKey);
                    logger.debug(logPrfx + " --- called thisEdgeType.setSortKey(sortKey)");
                    isChanged = true;
                }
            }
        }
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateSortKeyDeps(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateName1(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption){
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateName1Deps(@NotNull Screen screen, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
...
/*
        ...
        if(screen instanceof UsrEdgeBase0BaseMain
            ...
            String sortIdxMaxQry = "select max(e.sortIdx)"
                    + " from enty_"+ typeOfEdgeType.getSimpleName() +" e"
                    + " where e.parent1_Id = :parent1_Id"
                    ;
            try {
