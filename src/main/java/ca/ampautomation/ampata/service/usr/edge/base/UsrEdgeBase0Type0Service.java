...
public class UsrEdgeBase0Type0Service implements Globals {
     ...
     */
    public Boolean updateCalcVals(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption){
        String logPrfx = "updateCalcVals";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;

        isChanged = updateName1(view, thisEdgeType, updOption) || isChanged;

        isChanged = updateId2Calc(view, thisEdgeType, updOption) || isChanged;
        isChanged = updateId2Cmp(view, thisEdgeType, updOption) || isChanged;
        isChanged = updateId2Dup(view, thisEdgeType, updOption) || isChanged;
        isChanged = updateSortKey(view, thisEdgeType, updOption) || isChanged;
     ...
     */
    public Boolean updateId2(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateId2Deps(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
        String logPrfx = "updateId2Deps";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;

        isChanged = this.updateId2Cmp(view, thisEdgeType, updOption) || isChanged;
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Calc(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2CalcDeps(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Cmp(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Dup(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateSortIdxDeps(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateId2DupDeps(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateSortKey(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateSortKeyDeps(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateName1(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption){
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateName1Deps(@NotNull View view, @NotNull UsrEdgeBaseType thisEdgeType, @NotNull UpdateOption updOption) {
