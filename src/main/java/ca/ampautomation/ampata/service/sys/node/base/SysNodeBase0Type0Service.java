...
@Component("bean_SysNodeBase0TypeService")
public class SysNodeBase0Type0Service implements Globals {

    @Transient
    protected final Logger logger = LoggerFactory.getLogger(this.getClass());

    protected Class typeOfNodeType;

    public SysNodeBase0Type0Service() {
        this.typeOfNodeType = SysNodeBaseType.class;
    }
     ...
     */
    public Boolean updateCalcVals(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption){
     ...
     */
    public Boolean updateId2(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                String id2_ = thisNodeType.getId2();
                String id2 = thisNodeType.getId2Calc();
                logger.debug(logPrfx + " --- id2:" + id2);

                if(Objects.equals(id2_, id2)) {
                    logger.debug(logPrfx + " --- no change detected");
                }else{
                    thisNodeType.setId2(id2);
                    logger.debug(logPrfx + " --- called thisNodeType.setId2(id2)");
                    isChanged = true;
                }
            }
        }
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateId2Deps(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Calc(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                //name1 required
                Optional<String> o_name1 = Optional.ofNullable(thisNodeType.getName1());
                if(o_name1.isEmpty()) {
                ...
                String id2Calc_ = thisNodeType.getId2Calc();
                ...
                if (Objects.equals(id2Calc_, id2Calc)) {
                    ...
                    thisNodeType.setId2Calc(id2Calc);
                    logger.debug(logPrfx + " --- called thisNodeType.setId2Calc(id2Calc)");
                    isChanged = true;
                }
            }
        }
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2CalcDeps(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Cmp(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
        String logPrfx = "updateId2Cmp";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;
        Boolean id2Cmp_ = thisNodeType.getId2Cmp();
        Boolean id2Cmp = !Objects.equals(thisNodeType.getId2(),thisNodeType.getId2Calc());
        logger.debug(logPrfx + " --- id2Cmp:" + id2Cmp);

        if (Objects.equals(id2Cmp_, id2Cmp)) {
            logger.debug(logPrfx + " --- no change detected");
        }else{
            thisNodeType.setId2Cmp(id2Cmp);
            logger.debug(logPrfx + " --- called thisNodeType.setId2Cmp(id2Cmp)");
            isChanged = true;
        }
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateId2Dup(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                    ...
                    ,LOCAL__REF_IF_EMPTY_TO_EXIST_NEW
                    -> {
                Integer id2Dup_ = thisNodeType.getId2Dup();
                Integer id2Dup;
                if (thisNodeType.getId2() != null){
                    String id2Qry = "select count(e)"
                            + " from enty_" + thisNodeType.getClass().getSimpleName() + " e"
                            + " where e.id2 = :id2"
                            + " and e.id <> :id";
                    try{
                        id2Dup = this.dataManager.loadValue(id2Qry, Integer.class)
                                .store("main")
                                .parameter("id",thisNodeType.getId())
                                .parameter("id2",thisNodeType.getId2())
                                .one();
                    ...
                    if (Objects.equals(id2Dup_, id2Dup)) {
                        ...
                        thisNodeType.setId2Dup(id2Dup);
                        logger.debug(logPrfx + " --- called thisNodeType.setId2Cmp(l_id2Cmp_)");
                        isChanged = true;
                    }
                }
            }
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateSortIdxDeps(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateId2DupDeps(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateSortKey(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
        ...
        switch(updOption) {
            ...
            case     LOCAL
                ...
                //sortIdx optional
                Optional<Integer> o_sortIdx = Optional.ofNullable(thisNodeType.getSortIdx());
                ...
                Optional<String> o_parent1_SortKey = Optional.ofNullable(thisNodeType.getParent1_Id()).map(SysNodeBaseType::getSortKey);
                Optional<SysNodeBaseType> o_parent1_Id = Optional.ofNullable(thisNodeType.getParent1_Id());
                if(o_parent1_SortKey.isPresent()){
                    sb.insert(0,o_parent1_SortKey.get());
                }

                String sortKey_ = thisNodeType.getSortKey();
                String sortKey;
                ...
                if (Objects.equals(sortKey_, sortKey)) {
                    ...
                    thisNodeType.setSortKey(sortKey);
                    logger.debug(logPrfx + " --- called thisNodeType.setSortKey(sortKey)");
                    isChanged = true;
                }
            }
        }
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateSortKeyDeps(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
     ...
     * @return Boolean true if the field was changed, otherwise false
     */
    public Boolean updateName1(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption){
     ...
     * @return Boolean true if any field was changed, otherwise false
     */
    public Boolean updateName1Deps(@NotNull Screen screen, @NotNull SysNodeBaseType thisNodeType, @NotNull UpdateOption updOption) {
...
/*
        ...
        if(screen instanceof SysNodeBase0BaseMain
            ...
            notifications = ((SysNodeBase0BaseComn) screen).getNotifications();
            ...
            String sortIdxMaxQry = "select max(e.sortIdx)"
                    + " from enty_"+ typeOfNodeType.getSimpleName() +" e"
                    + " where e.parent1_Id = :parent1_Id"
                    ;
            try {
