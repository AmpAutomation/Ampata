...
public class FinTxactBrowse2 extends MasterDetailScreen<SysNode> {
    ...
    @Autowired
    protected PropertyFilter<SysNodeType> filterConfig1A_finTxset1_Id_type1_Id;

    @Autowired
    protected PropertyFilter<SysNode> filterConfig1A_finTxset1_Id_genChan1_Id;
    ...
    @Autowired
    protected PropertyFilter<SysNode> filterConfig1A_finTxset1_Id_genTag1_Id;
    ...
    @Autowired
    protected PropertyFilter<SysNodeType> filterConfig1B_finTxset1_Id_type1_Id;

    @Autowired
    protected PropertyFilter<SysNode> filterConfig1B_finTxset1_Id_genChan1_Id;
    ...
    @Autowired
    protected PropertyFilter<SysNode> filterConfig1B_finTxset1_Id_genTag1_Id;
    ...
    @Autowired
    protected EntityComboBox<SysNodeType> tmplt_FinTxset1_Id_Type1_IdField;

    @Autowired
    protected CheckBox tmplt_FinTxset1_Id_Type1_IdFieldChk;

    @Autowired
    protected EntityComboBox<SysNode> tmplt_FinTxset1_Id_GenChan1_IdField;
    ...
    @Autowired
    private InstanceContainer<SysNode> finTxactDc;
    ...
    @Autowired
    private EntityComboBox<SysPat> desc1SysPat1_IdField;
    ...
    // FinTxset
    @Autowired
    private EntityComboBox<SysNode> finTxset1_IdField;

    @Autowired
    private TextField<String> finTxset1_Id2TrgtField;

    @Autowired
    private EntityComboBox<SysNodeType> finTxset1_Id_Type1_IdField;

    @Autowired
    private ComboBox<String> finTxset1_EI1_RoleField;

    @Autowired
    private EntityComboBox<SysNode> finTxset1_Id_GenChan1_IdField;
    ...
    @Autowired
    private EntityComboBox<SysPat> finTxset1_Id_Desc1SysPat1_IdField;

    @Autowired
    private EntityComboBox<SysNode> finTxset1_Id_Desc1FinTxactItm1_IdField;
    ...
    public void onInit(InitEvent event) {
        ...
        propFilterCmpnt_genChan1_Id = (EntityComboBox<SysNode>) filterConfig1A_finTxset1_Id_genChan1_Id.getValueComponent();
        propFilterCmpnt_genChan1_Id.setOptionsContainer(genChansDc);
        propFilterCmpnt_genChan1_Id = (EntityComboBox<SysNode>) filterConfig1B_finTxset1_Id_genChan1_Id.getValueComponent();
        propFilterCmpnt_genChan1_Id.setOptionsContainer(genChansDc);
        ...
        desc1SysPat1_IdField.setOptionsContainer(sysPatsDc);
        finTxset1_Id_Desc1SysPat1_IdField.setOptionsContainer(sysPatsDc);
        ...
        //filter
        EntityComboBox<SysNodeType> propFilterCmpnt_finTxsetType1_Id;
        propFilterCmpnt_finTxsetType1_Id = (EntityComboBox<SysNodeType>) filterConfig1A_finTxset1_Id_type1_Id.getValueComponent();
        propFilterCmpnt_finTxsetType1_Id.setOptionsContainer(finTxsetTypesDc);
        propFilterCmpnt_finTxsetType1_Id = (EntityComboBox<SysNodeType>) filterConfig1B_finTxset1_Id_type1_Id.getValueComponent();
        propFilterCmpnt_finTxsetType1_Id.setOptionsContainer(finTxsetTypesDc);
    ...
    */
    ...
    public void onInitEntity(InitEntityEvent<SysNode> event) {
        ...
        SysNode thisFinTxact = event.getEntity();
    ...
    */
    ...
    public void onFinTxactsDcItemChange(InstanceContainer.ItemChangeEvent<SysNode> event) {
        ...
        SysNode thisFinTxact = event.getItem();
        if (thisFinTxact == null) {
            logger.debug(logPrfx + " --- thisFinTxact is null, likely because no record is selected.");
            logger.trace(logPrfx + " <-- ");
            return;
    ...
    public void onPurgeColBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing Db-Proc.Fin_Txact_Pr_Purge()");
        repo.execFinTxactPrPurgeNative();
        logger.debug(logPrfx + " --- finished Db-Proc.Fin_Txact_Pr_Purge()");
    ...
    public void onDeleteColOrphansBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing Db-Proc.Fin_Txact_Pr_Del_Orph()");
        repo.execFinTxactPrDelOrphNative();
        logger.debug(logPrfx + " --- finished Db-Proc.Fin_Txact_Pr_Del_Orph()");
    ...
    public void onSetBtnClick(Button.ClickEvent event) {
        ...
        thisFinTxacts.forEach(thisFinTxact -> {
            SysNode thisTrackedFinTxact = dataContext.merge(thisFinTxact);
    ...
    public void onUpdateInstIdPartsBtnClick(Button.ClickEvent event) {
        ...
        SysNode thisFinTxact = finTxactDc.getItemOrNull();
        if (thisFinTxact == null) {
            logger.debug(logPrfx + " --- thisFinTxact is null, likely because no record is selected.");
            notifications.create().withCaption("No record selected. Please select a record.").show();
            logger.trace(logPrfx + " <-- ");
    ...
    private Boolean updateCalcVals(@NotNull SysNode thisFinTxact, Integer finTxsetOption) {
    ...
    private Boolean updateFinTxactCalcVals(@NotNull SysNode thisFinTxact, Integer finTxsetOption) {
        String logPrfx = "updateCalcVals";
        logger.trace(logPrfx + " --> ");
    ...
    private Boolean updateFinTxsetCalcVals(@NotNull SysNode thisFinTxact) {
    ...
    private Boolean updateIdParts(@NotNull SysNode thisFinTxact) {
    ...
    private Boolean updateId2(@NotNull SysNode thisFinTxact) {
    ...
    private Boolean updateId2Calc(SysNode thisFinTxact){
        // Assume thisFinTxact is not null
    ...
    private Boolean updateId2Cmp(SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateId2Dup(SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
        ...
        if (thisFinTxact.getId2() != null) {
            String id2Qry = "select count(e) from ampata_SysNode e where e.className = 'FinTxact' and e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try {
    ...
    private Boolean updateDesc1(SysNode thisFinTxact){
        // Assume thisFinTxact is not null
    ...
    private Boolean updateFinTxset1_Id_Desc1(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateIdDt(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateBeg1(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateBeg2(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateIdX(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateIdY(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateFinTxset1_Id(@NotNull SysNode thisFinTxact, Integer finTxsetOption) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateFinTxset1_Id2Trgt(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private SysNode findFinTxsetById2(@NotNull String finTxset_Id2) {
    ...
    private SysNode createFinTxsetFrFinTxact(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
        ...
        try {
            ...
            SysNode mergedFinTxset = dataContext.merge(savedFinTxset);
    ...
    private Boolean updateFinTxactItms1_IdCntCalc(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
        ...
        String qry1 = "select count(e.amtNet) from ampata_SysNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id";
        try{
    ...
    private Boolean updateFinTxactItms1_AmtDebtSumCalc(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateFinTxactItms1_AmtCredSumCalc(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateFinTxactItms1_AmtEqCalc(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private Boolean updateFinTxactItms1_FinCurcyEqCalc(@NotNull SysNode thisFinTxact) {
        // Assume thisFinTxact is not null
    ...
    private SysNode findFinTxactItmById2(@NotNull String finTxactItm_Id2) {
