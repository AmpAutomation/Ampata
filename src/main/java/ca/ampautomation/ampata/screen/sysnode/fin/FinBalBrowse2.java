...
public class FinBalBrowse2 extends MasterDetailScreen<SysNode> {
    ...
    @Autowired
    protected PropertyFilter<SysNode> propFilter_finBalSet1_Id;

    @Autowired
    protected PropertyFilter<SysNode> propFilter_finAcct1_Id;
    ...
    @Autowired
    private InstanceContainer<SysNode> finBalDc;


    private CollectionContainer<SysNodeType> finBalTypesDc;

    private CollectionLoader<SysNodeType> finBalTypesDl;
    ...
    private CollectionContainer<SysNode> finBal1sDc;

    private CollectionLoader<SysNode> finBal1sDl;
    ...
    @Autowired
    private EntityComboBox<SysNode> finBal1_IdField;
    ...
    @Autowired
    private Table<SysNode> tableFinTxactItm;
    ...
    public void onInit(InitEvent event) {
        ...
        finBalTypesDc = dataComponents.createCollectionContainer(SysNodeType.class);
        finBalTypesDl = dataComponents.createCollectionLoader();
        finBalTypesDl.setQuery("select e from ampata_SysNodeType e where e.className = 'FinBal' order by e.id2");
        FetchPlan finBalTypesFp = fetchPlans.builder(SysNodeType.class)
        ...
        finBalSetsDc = dataComponents.createCollectionContainer(SysNode.class);
        finBalSetsDl = dataComponents.createCollectionLoader();
        finBalSetsDl.setQuery("select e from ampata_SysNode e where e.className = 'FinBalSet' order by e.id2");
        FetchPlan finBalSetsFp = fetchPlans.builder(SysNode.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        EntityComboBox<SysNode> propFilterCmpnt_finBalSet1_Id = (EntityComboBox<SysNode>) propFilter_finBalSet1_Id.getValueComponent();
        ...
        //filter
        EntityComboBox<SysNode> propFilterCmpnt_finAcct1_Id = (EntityComboBox<SysNode>) propFilter_finAcct1_Id.getValueComponent();
        ...
        finBal1sDc = dataComponents.createCollectionContainer(SysNode.class);
        finBal1sDl = dataComponents.createCollectionLoader();
        finBal1sDl.setQuery("select e from ampata_SysNode e where e.className = 'FinBal' order by e.id2");
        FetchPlan finBal1sFp = fetchPlans.builder(SysNode.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
    ...
    public void onFinBalsDcCollectionChange(CollectionContainer.CollectionChangeEvent<SysNode> event) {
    ...
    @Subscribe(id = "finBalsDc", target = Target.DATA_CONTAINER)
    public void onFinBalsDcItemChange(InstanceContainer.ItemChangeEvent<SysNode> event) {
        String logPrfx = "onFinBalsDcItemChange";
        logger.trace(logPrfx + " --> ");

        SysNode thisFinBal = event.getItem();
        if (thisFinBal == null) {
    ...
    public void onDuplicateBtnClick(Button.ClickEvent event) {
        ...
        List<SysNode> thisFinBals = table.getSelected().stream().toList();
    ...
    public void onSetBtnClick(Button.ClickEvent event) {
        ...
        thisFinBals.forEach(thisFinBal -> {
            SysNode thisTrackedFinBal = dataContext.merge(thisFinBal);
    ...
    public void onFinBalDcItemChange(InstanceContainer.ItemChangeEvent<SysNode> event) {
        String logPrfx = "onFinBalDcItemChange";
        logger.trace(logPrfx + " --> ");

        SysNode thisFinBal = event.getSource().getItemOrNull();
        if (thisFinBal == null) {
            logger.debug(logPrfx + " --- thisFinBal is null, likely because no record is selected.");
            //todo I observed thisFinBal is null when selecting a new item
            //notifications.create().withCaption("No record selected. Please select a record.").show();
    ...
    public void onUpdateDesc1FieldBtn(Button.ClickEvent event) {
        ...
        SysNode thisFinBal = finBalDc.getItemOrNull();
        if (thisFinBal == null) {
            logger.debug(logPrfx + " --- thisFinBal is null, likely because no record is selected.");
            notifications.create().withCaption("No record selected. Please select a record.").show();
            logger.trace(logPrfx + " <-- ");
    ...
    public Boolean updateManVals(SysNode thisFinBal){
    ...
    public Boolean updateCalcVals(SysNode thisFinBal){
    ...
    private Boolean updateFinBalCalcVals(@NotNull SysNode thisFinBal) {
    ...
    private Boolean updateIdParts(@NotNull SysNode thisFinBal) {
    ...
    private Boolean updateId2(@NotNull SysNode thisFinBal) {
    ...
    private Boolean updateId2Calc(SysNode thisFinBal){
        // Assume thisFinBal is not null
    ...
    private Boolean updateId2Cmp(@NotNull SysNode thisFinBal) {
        // Assume thisFinBal is not null
    ...
    private Boolean updateId2Dup(@NotNull SysNode thisFinBal) {
        // Assume thisFinBal is not null
        ...
        if (thisFinBal.getId2() != null){
            String id2Qry = "select count(e) from ampata_SysNode e where e.className = 'FinBal' and e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try{
    ...
    private Boolean updateDesc1(@NotNull SysNode thisFinBal){
        // Assume thisFinBal is not null
    ...
    private Boolean updateIdDt(@NotNull SysNode thisFinBal) {
        // Assume thisFinBal is not null
    ...
    public Boolean updateAmtDebt(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateAmtCred(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateAmtNet(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateAmtBegBal(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateAmtBegBalCalc(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateAmtEndBal(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateAmtEndBalCalc(@NotNull SysNode thisFinBal){
    ...
    public Boolean updateFinTxactItms1_FieldSet(@NotNull SysNode thisFinBal) {
        ...
        SysNode finAcct1 = thisFinBal.getFinAcct1_Id();
        SysNode finDept1 = thisFinBal.getFinDept1_Id();
        ...
        try{
            ...
            if (finDept1 == null) {
                finTxactItms1_QryCnt = "select count(e) from ampata_SysNode e"
        ...
        try{
            ...
            if (finDept1 == null) {
                finTxactItms1_QryDebt = "select sum(e.amtDebt) from ampata_SysNode e"
                        + " where e.className = 'FinTxactItm'"
                        + " and e.finAcct1_Id = :finAcct1_Id"
                        + " and e.idDt.date1 between :begDt and :endDt"
                        + "";
        ...
        try {
            ...
            if (finDept1 == null) {
                finTxactItms1_QryCred = "select sum(e.amtCred) from ampata_SysNode e"
                        + " where e.className = 'FinTxactItm'"
                        + " and e.finAcct1_Id = :finAcct1_Id"
                        + " and e.idDt.date1 between :begDt and :endDt"
                        + "";
    ...
    private Boolean updateEnd1(@NotNull SysNode thisFinBal) {
        // Assume thisFinBal is not null
    ...
    private SysNode findFinBalById2(@NotNull String FinBal_Id2) {
        ...
        String qry = "select e from ampata_SysNode e where e.className = 'FinBal' and e.id2 = :id2";
        logger.debug(logPrfx + " --- qry: " + qry);
        logger.debug(logPrfx + " --- qry:id2: " + FinBal_Id2);

        SysNode FinBal1_Id = null;
        try {
            FinBal1_Id = dataManager.load(SysNode.class)
                    .query(qry)
    ...
    public void loadTableFinTxactItm(@NotNull SysNode thisFinBal) {
