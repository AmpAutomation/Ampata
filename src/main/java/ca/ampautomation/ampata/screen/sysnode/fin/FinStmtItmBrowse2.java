...
public class FinStmtItmBrowse2 extends MasterDetailScreen<SysNode> {
    ...
    @Autowired
    protected PropertyFilter<SysNode> filterConfig1A_finStmt1_Id;
    ...
    @Autowired
    protected EntityComboBox<SysNode> tmplt_FinStmt1_IdField;
    ...
    @Autowired
    private InstanceContainer<SysNode> finStmtItmDc;

    private CollectionContainer<SysNodeType> finStmtItmTypesDc;

    private CollectionLoader<SysNodeType> finStmtItmTypesDl;
    ...
    @Autowired
    private EntityComboBox<SysNode> finStmt1_IdField;
 ...
 */
    ...
    public void onInit(InitEvent event) {
        ...
        finStmtItmTypesDc = dataComponents.createCollectionContainer(SysNodeType.class);
        finStmtItmTypesDl = dataComponents.createCollectionLoader();
        finStmtItmTypesDl.setQuery("select e from ampata_SysNodeType e where e.className = 'FinStmtItm' order by e.id2");
        FetchPlan finStmtItmTypesFp = fetchPlans.builder(SysNodeType.class)
        ...
        //filter
        EntityComboBox<SysNode> propFilterCmpnt_finStmt1_Id = (EntityComboBox<SysNode>) filterConfig1A_finStmt1_Id.getValueComponent();
        ...
        //filter
        EntityComboBox<SysNode> propFilterCmpnt_finAcct1_Id = (EntityComboBox<SysNode>) filterConfig1A_finAcct1_Id.getValueComponent();
    ...
    */
    ...
    public void onInitEntity(InitEntityEvent<SysNode> event) {
        ...
        SysNode thisFinStmtItm = event.getEntity();
    ...
    */
    ...
    public void onFinStmtItmsDcItemChange(InstanceContainer.ItemChangeEvent<SysNode> event) {
        String logPrfx = "onFinStmtItmsDcItemChange";
        logger.trace(logPrfx + " --> ");

        SysNode thisFinStmtItm = event.getItem();
        if (thisFinStmtItm == null) {
            logger.debug(logPrfx + " --- thisFinStmtItm is null, likely because no record is selected.");
            logger.trace(logPrfx + " <-- ");
            return;
    ...
    public void onDuplicateBtnClick(Button.ClickEvent event) {
        ...
        List<SysNode> thisFinStmtItms = table.getSelected().stream().toList();
    ...
    public void onSetBtnClick(Button.ClickEvent event) {
        ...
        thisFinStmtItms.forEach(thisFinStmtItm -> {
            SysNode thisTrackedFinStmtItm = dataContext.merge(thisFinStmtItm);
    ...
    public void onUpdateInstIdPartsBtnClick(Button.ClickEvent event) {
        ...
        SysNode thisFinStmtItm = finStmtItmDc.getItemOrNull();
        if (thisFinStmtItm == null) {
            logger.debug(logPrfx + " --- thisFinStmtItm is null, likely because no record is selected.");
            notifications.create().withCaption("No record selected. Please select a record.").show();
            logger.trace(logPrfx + " <-- ");
    ...
    private Boolean updateCalcVals(@NotNull SysNode thisFinStmtItm) {
    ...
    private Boolean updateFinStmtItmCalcVals(@NotNull SysNode thisFinStmtItm) {
    ...
    private Boolean updateIdParts(@NotNull SysNode thisFinStmtItm) {
    ...
    private Boolean updateId2(@NotNull SysNode thisFinStmtItm) {
    ...
    private Boolean updateId2Calc(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private Boolean updateId2Cmp(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private Boolean updateId2Dup(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
        ...
        if (thisFinStmtItm.getId2() != null) {
            String id2Qry = "select count(e) from ampata_SysNode e where e.className = 'FinStmtItm' and e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try {
    ...
    private Boolean updateIdDt(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private Boolean updateBeg1(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private Boolean updateBeg2(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private Boolean updateIdX(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    public Boolean updateAmtNet(@NotNull SysNode thisFinStmtItm) {
        //Assume thisFinStmtItm is not null
        ...
        SysNode thisFinStmt = thisFinStmtItm.getFinStmt1_Id();
        if (thisFinStmt == null) {
        ...
        SysNode thisFinAcct = thisFinStmt.getFinAcct1_Id();
        if (thisFinAcct == null) {
    ...
    private Boolean updateFinTxactItms1_IdCntCalc(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
        ...
        String qry1 = "select count(e.amtNet) from ampata_SysNode e where e.className = 'FinTxactItm' and e.finStmtItm1_Id = :finStmtItm1_Id";
        try{
    ...
    private Boolean updateFinTxactItms1_AmtDebtSumCalc(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
        ...
        String qry1 = "select sum(e.amtDebt) from ampata_SysNode e where e.className = 'FinTxactItm' and e.finStmtItm1_Id = :finStmtItm1_Id";
        try{
    ...
    private Boolean updateFinTxactItms1_AmtCredSumCalc(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
        ...
        String qry1 = "select sum(e.amtCred) from ampata_SysNode e where e.className = 'FinTxactItm' and e.finStmtItm1_Id = :finStmtItm1_Id";
        try{
    ...
    private Boolean updateFinTxactItms1_AmtNetSumCalc(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private Boolean updateFinTxactItms1_AmtEqCalc(@NotNull SysNode thisFinStmtItm) {
        // Assume thisFinStmtItm is not null
    ...
    private SysNode findFinStmtItmById2(@NotNull String finStmtItm_Id2) {
        ...
        SysNode finStmtItm1_Id = null;
        try {
            finStmtItm1_Id = dataManager.load(SysNode.class)
                    .query(qry)
