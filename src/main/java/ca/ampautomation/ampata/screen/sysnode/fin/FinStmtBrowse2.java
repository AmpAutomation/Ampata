...
public class FinStmtBrowse2 extends MasterDetailScreen<SysNode> {
    ...
    @Autowired
    protected PropertyFilter<SysNode> propFilter_genChan1_Id;
    ...
    @Autowired
    private InstanceContainer<SysNode> finStmtDc;
    ...
    private CollectionContainer<SysNodeType> finStmtTypesDc;

    private CollectionLoader<SysNodeType> finStmtTypesDl;
    ...
    public void onInit(InitEvent event) {
        ...
        finStmtTypesDc = dataComponents.createCollectionContainer(SysNodeType.class);
        finStmtTypesDl = dataComponents.createCollectionLoader();
        finStmtTypesDl.setQuery("select e from ampata_SysNodeType e where e.className = 'FinStmt' order by e.id2");
        FetchPlan finStmtTypesFp = fetchPlans.builder(SysNodeType.class)
        ...
        EntityComboBox<SysNode> propFilterCmpnt_genChan1_Id = (EntityComboBox<SysNode>) propFilter_genChan1_Id.getValueComponent();
    ...
    public void onFinStmtsDcCollectionChange(CollectionContainer.CollectionChangeEvent<SysNode> event) {
    ...
    @Subscribe(id = "finStmtsDc", target = Target.DATA_CONTAINER)
    public void onFinStmtsDcItemChange(InstanceContainer.ItemChangeEvent<SysNode> event) {
        String logPrfx = "onFinStmtsDcItemChange";
        logger.trace(logPrfx + " --> ");

        SysNode thisFinStmt = event.getItem();
        if (thisFinStmt == null) {
    ...
    public void onDuplicateBtnClick(Button.ClickEvent event) {
        ...
        List<SysNode> thisFinStmts = table.getSelected().stream().toList();
    ...
    public void onSetBtnClick(Button.ClickEvent event) {
        ...
        thisFinStmts.forEach(thisFinStmt -> {
            SysNode thisTrackedFinStmt = dataContext.merge(thisFinStmt);
    ...
    public void onFinStmtDcItemChange(InstanceContainer.ItemChangeEvent<SysNode> event) {
        String logPrfx = "onFinStmtDcItemChange";
        logger.trace(logPrfx + " --> ");

        SysNode thisFinStmt = event.getSource().getItemOrNull();
        if (thisFinStmt == null) {
            logger.debug(logPrfx + " --- thisFinStmt is null, likely because no record is selected.");
            //todo I observed thisFinStmt is null when selecting a new item
            //notifications.create().withCaption("No record selected. Please select a record.").show();
    ...
    public void onUpdateDesc1FieldBtn(Button.ClickEvent event) {
        ...
        SysNode thisFinStmt = finStmtDc.getItemOrNull();
        if (thisFinStmt == null) {
            logger.debug(logPrfx + " --- thisFinStmt is null, likely because no record is selected.");
            notifications.create().withCaption("No record selected. Please select a record.").show();
            logger.trace(logPrfx + " <-- ");
    ...
    public Boolean updateCalcVals(SysNode thisFinStmt){
    ...
    private Boolean updateFinStmtCalcVals(@NotNull SysNode thisFinStmt) {
    ...
    private Boolean updateIdParts(@NotNull SysNode thisFinStmt) {
    ...
    private Boolean updateId2(@NotNull SysNode thisFinStmt) {
    ...
    private Boolean updateId2Calc(SysNode thisFinStmt){
        // Assume thisFinStmt is not null
    ...
    private Boolean updateId2Cmp(@NotNull SysNode thisFinStmt) {
        // Assume thisFinStmt is not null
    ...
    private Boolean updateId2Dup(@NotNull SysNode thisFinStmt) {
        // Assume thisFinStmt is not null
        ...
        if (thisFinStmt.getId2() != null){
            String id2Qry = "select count(e) from ampata_SysNode e where e.className = 'FinStmt' and e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try{
    ...
    private Boolean updateDesc1(@NotNull SysNode thisFinStmt){
        // Assume thisFinStmt is not null
    ...
    private Boolean updateIdDt(@NotNull SysNode thisFinStmt) {
        // Assume thisFinStmt is not null
    ...
    public Boolean updateAmtNet(@NotNull SysNode thisFinStmt){
    ...
    public Boolean updateAmtBegBalCalc(@NotNull SysNode thisFinStmt){
        ...
        SysNode prevFinStmt = findFinStmtById2(sb.toString());
        if (prevFinStmt == null  ){
        ...
        public Boolean updateAmtEndBalCalc(@NotNull SysNode thisFinStmt){
    ...
    public Boolean updateFinStmtItms1_FieldSet(@NotNull SysNode thisFinStmt) {
        ...
        String finStmtItms1_QryDebt = "select sum(e.amtDebt) from ampata_SysNode e where e.className = 'FinStmtItm' and e.finStmt1_Id = :finStmt1_Id";
        try{
        ...
        String finStmtItms1_QryCred = "select sum(e.amtCred) from ampata_SysNode e where e.className = 'FinStmtItm' and e.finStmt1_Id = :finStmt1_Id";
        try {
    ...
    public Boolean updateFinTxactItms1_FieldSet(@NotNull SysNode thisFinStmt) {
        ...
        String finTxactItms1_QryDebt = "select sum(e.amtDebt) from ampata_SysNode e join e.finStmtItm1_Id e2 where e.className = 'FinTxactItm' and e2.finStmt1_Id = :finStmt1_Id";
        try{
        ...
        String finTxactItms1_QryCred = "select sum(e.amtCred) from ampata_SysNode e join e.finStmtItm1_Id e2 where e.className = 'FinTxactItm' and e2.finStmt1_Id = :finStmt1_Id";
        try {
    ...
    private Boolean updateEnd1(@NotNull SysNode thisFinStmt) {
        // Assume thisFinStmt is not null
    ...
    private SysNode findFinStmtById2(@NotNull String FinStmt_Id2) {
        ...
        String qry = "select e from ampata_SysNode e where e.className = 'FinStmt' and e.id2 = :id2";
        logger.debug(logPrfx + " --- qry: " + qry);
        logger.debug(logPrfx + " --- qry:id2: " + FinStmt_Id2);

        SysNode FinStmt1_Id = null;
        try {
            FinStmt1_Id = dataManager.load(SysNode.class)
                    .query(qry)
