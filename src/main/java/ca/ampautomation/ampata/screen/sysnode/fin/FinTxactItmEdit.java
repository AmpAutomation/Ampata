...
public class FinTxactItmEdit extends StandardEditor<SysNode> {
    ...
    @Autowired
    private EntityComboBox<SysNode> finTxact1_Id_GenChan1_IdField;
    ...
    @Autowired
    private EntityComboBox<SysPat> finTxact1_Id_Desc1SysPat1_IdField;
    ...
    @Autowired
    private EntityComboBox<SysPat> finTxact1_Id_FinTxset1_Id_Desc1SysPat1_IdField;
    ...
    public void onInit(InitEvent event) {
        ...
        finTxact1_Id_Desc1SysPat1_IdField.setOptionsContainer(sysPatsDc);
        finTxact1_Id_FinTxset1_Id_Desc1SysPat1_IdField.setOptionsContainer(sysPatsDc);
    ...
    */
    ...
    private Boolean updateCalcVals(@NotNull SysNode thisFinTxactItm, Integer finTxactOption, Integer finTxsetOption) {
...
//        isChanged = updateFinTaxLne1_Id(thisFinTxactItm) || isChanged;
    ...
    private Boolean updateFinTxact1_Id_FinTxset1_Id_Desc1(@NotNull SysNode thisFinTxactItm) {
        ...
        if (thisFinTxset != null) {
            ...
            SysNode thisTrackedTxset = dataContext.merge(thisFinTxset);
    ...
    private Boolean updateIdTs(@NotNull SysNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_AmtDebtSumCalc(@NotNull SysNode thisFinTxactItm) {
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select sum(e.amtDebt) from ampata_SysNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id";
            try{
    ...
    private SysNode findFinTxactById2(@NotNull String finTxact_Id2) {
