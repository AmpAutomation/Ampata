...
@UiController("ampata_UsrFinBal.browse2")
@UiDescriptor("usr-fin-bal-browse2.xml")
@LookupComponent("table")
public class UsrFinBalBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    Logger logger = LoggerFactory.getLogger(UsrFinBalBrowse2.class);
    ...
    public void loadTableFinTxactItm(@NotNull UsrNode thisFinBal) {
        ...
        try{
            ...
            FetchPlan finTxactItmsFp = fetchPlans.builder(UsrNode.class)
                    .addFetchPlan("usrFinTxactItm-fetch-plan-base")
                    .build();
