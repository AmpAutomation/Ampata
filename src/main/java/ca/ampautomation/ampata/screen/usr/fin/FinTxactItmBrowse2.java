...
public class FinTxactItmBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    public void onInit(InitEvent event) {
        ...
        //filter
        EntityComboBox<UsrNodeType> propFilterCmpnt_finTxact1_Id_finTxset1_Id_ype1_Id;
        propFilterCmpnt_finTxact1_Id_finTxset1_Id_ype1_Id = (EntityComboBox<UsrNodeType>) filterConfig1A_finTxact1_Id_finTxset1_Id_type1_Id.getValueComponent();
        propFilterCmpnt_finTxact1_Id_finTxset1_Id_ype1_Id.setOptionsContainer(finTxsetTypesDc);
        propFilterCmpnt_finTxact1_Id_finTxset1_Id_ype1_Id = (EntityComboBox<UsrNodeType>) filterConfig1B_finTxact1_Id_finTxset1_Id_type1_Id.getValueComponent();
        propFilterCmpnt_finTxact1_Id_finTxset1_Id_ype1_Id.setOptionsContainer(finTxsetTypesDc);
