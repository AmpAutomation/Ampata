...
@UiController("ampata_UsrFinBalSet.browse2")
@UiDescriptor("usr-fin-bal-set-browse2.xml")
@LookupComponent("table")
public class UsrFinBalSetBrowse2 extends MasterDetailScreen<UsrNode> {

    //Common
    Logger logger = LoggerFactory.getLogger(UsrFinBalSetBrowse2.class);
    ...
    //Main data loaders, containers and table
    @Autowired
    ...
    public void onInit(InitEvent event) {
        ...
        propFilterCmpnt_Type1_Id.setOptionsContainer(finAcctTypesDc);
    ...
    public void loadTableFinBal(@NotNull UsrNode thisFinBalSet) {
        ...
        try{
            ...
            FetchPlan finBalsFp = fetchPlans.builder(UsrNode.class)
                    .addFetchPlan("usrFinBal-fetch-plan-base")
                    .build();
