...
@UiController("ampata_UsrFinAcct.browse2")
@UiDescriptor("usr-fin-acct-browse2.xml")
@LookupComponent("table")
public class UsrFinAcctBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    Logger logger = LoggerFactory.getLogger(UsrFinAcctBrowse2.class);
 ...
 */
    ...
    public void onInit(InitEvent event) {
        ...
        usrFinTaxLnesDl.setQuery("select e from ampata_UsrNode e where e.className = 'GenDocFrg' order by e.id2");
    ...
    */
    ...
    public void onUpdateColCalcValsBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- calling repo.execFinAcctPrUpdNative()");
        repo.execFinAcctPrUpdNative();
        logger.debug(logPrfx + " --- finished repo.execFinAcctPrUpdNative()");
    ...
    private Boolean updateId2Dup(@NotNull UsrNode thisFinAcct) {
        ...
        if (thisFinAcct.getId2() != null) {
            String id2Qry = "select count(e) from ampata_UsrNode e"
                    + " where e.className = 'FinAcct'"
                    + " and e.id2 = :id2"
                    + " and e.id <> :id"
                    ;
    ...
    private UsrNode getFinAcctBySortIdx(@NotNull Integer sortIdx, UsrNode parent1_Id) {
        ...
        String qry = "select e from ampata_UsrNode e"
                + " where e.className = 'FinAcct'"
    ...
    private void reloadStatusList(){
        ...
        String qry = "select distinct e.status from ampata_UsrNode e"
                + " where e.className = 'FinAcct'"
