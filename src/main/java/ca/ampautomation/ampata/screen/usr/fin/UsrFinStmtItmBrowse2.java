...
@UiController("ampata_UsrFinStmtItm.browse2")
@UiDescriptor("usr-fin-stmt-itm-browse2.xml")
@LookupComponent("table")
public class UsrFinStmtItmBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    Logger logger = LoggerFactory.getLogger(UsrFinStmtItmBrowse2.class);
 ...
 */
    ...
    */
    ...
    public void onDuplicateBtnClick(Button.ClickEvent event) {
        ...
        List<UsrNode> thisFinStmtItms = table.getSelected().stream().toList();
