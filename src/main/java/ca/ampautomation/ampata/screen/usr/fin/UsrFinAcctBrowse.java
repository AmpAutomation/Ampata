...
@UiController("ampata_UsrFinAcct.browse")
@UiDescriptor("usr-fin-acct-browse.xml")
@LookupComponent("table")
public class UsrFinAcctBrowse extends StandardLookup<UsrNode> {
    ...
    Logger logger = LoggerFactory.getLogger(UsrFinAcctBrowse.class);
