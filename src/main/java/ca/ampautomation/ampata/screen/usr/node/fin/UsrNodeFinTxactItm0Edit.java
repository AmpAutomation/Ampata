...
import ca.ampautomation.ampata.entity.usr.node.fin.UsrNodeFinTxactItmQryMngr;
...
public class UsrNodeFinTxactItm0Edit extends StandardEditor<UsrNodeBase> {
    ...
    @Autowired
    private EntityComboBox<UsrNodeGenChan> finTxact1_Id_GenChan1_IdField;

    @Autowired
    private EntityComboBox<UsrItemFinHow> finTxact1_Id_FinHow1_IdField;

    @Autowired
    private ComboBox<String> finTxact1_Id_WhatText1Field;

    @Autowired
    private EntityComboBox<UsrItemFinWhat> finTxact1_Id_FinWhat1_IdField;

    @Autowired
    private ComboBox<String> finTxact1_Id_WhyText1Field;

    @Autowired
    private EntityComboBox<UsrItemFinWhy> finTxact1_Id_FinWhy1_IdField;
    ...
    public void onInit(InitEvent event) {
        ...
        colLoadrFinTaxLne.setQuery("select e from enty_UsrNodeGenDocFrg e order by e.sortKey, e.id2");
        ...
        FetchPlan fchPlnAmtCalcGenFmla_Inst = fetchPlans.builder(UsrItemGenFmla.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        colLoadrAmtCalcGenFmla.setFetchPlan(fchPlnAmtCalcGenFmla_Inst);
    ...
    */
    ...
    @Subscribe("updateAmtGenFmla1_IdFieldListBtn")
    public void onUpdateAmtGenFmla1_IdFieldListBtn(Button.ClickEvent event) {
        String logPrfx = "onUpdateAmtGenFmla1_IdFieldListBtn";
        logger.trace(logPrfx + " --> ");
...
//        isChanged = updateFinTaxLne1_Id(thisFinTxactItm) || isChanged;
    ...
    private Boolean updateId2Dup(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        if (thisFinTxactItm.getId2() != null) {
            String id2Qry = "select count(e) from enty_UsrNodeFinTxactItm e where e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try {
    ...
    private Boolean updateDesc1(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        String thisCurcy = "";
        if (thisFinTxactItm.getSysNodeFinCurcy1_Id() != null) {
            thisCurcy = Objects.toString(thisFinTxactItm.getSysNodeFinCurcy1_Id().getId2(), "");
        }
            ...
            if (thisFinTxactSet.getDesc1GenFmla1_Id() == null) {
                ...
                if (desc1FinTxactItm1 != null) {
                    if (desc1FinTxactItm1.getSysNodeFinCurcy1_Id() != null) {
                        thisCurcy = Objects.toString(desc1FinTxactItm1.getSysNodeFinCurcy1_Id().getId2(), "");
                    }
                }
                logger.debug(logPrfx + " --- thisCurcy: " + thisCurcy);
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_IdCntCalc(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select count(e.amtNet) from enty_UsrNodeFinTxactItm e where e.finTxact1_Id = :finTxact1_Id group by e.finTxact1_Id";
            try{
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_AmtDebtSumCalc(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select sum(e.amtDebt) from enty_UsrNodeFinTxactItm e where e.finTxact1_Id = :finTxact1_Id";
            try{
    ...
    private UsrNodeBase findFinTxactItmById2(@NotNull String finTxactItm_Id2) {
        ...
        String qry = "select e from enty_UsrNodeFinTxactItme where e.id2 = :id2";
    ...
    private UsrNodeBase findFinTxactById2(@NotNull String finTxact_Id2) {
        ...
        String qry = "select e from enty_UsrNodeFinTxact e where e.id2 = :id2";
        logger.debug(logPrfx + " --- qry: " + qry);
    ...
    private UsrNodeBase createFinTxactFrFinTxactItm(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        try {
            ...
            newFinTxact.setClassName("UsrNodeFinTxact");
    ...
    private UsrNodeBase findFinTxactSetById2(@NotNull String finTxactSet_Id2) {
        ...
        String qry = "select e from enty_UsrNodeFinTxactSete where e.id2 = :id2";
        logger.debug(logPrfx + " --- qry: " + qry);
    ...
    private Boolean updateAmtFinTxactItm1_EI1_Rate(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        UsrItemGenFmla amtGenFmla1 = thisFinTxactItm.getAmtCalcGenFmla1_Id();
        if (amtGenFmla1 == null) {
            logger.debug(logPrfx + " --- amtGenFmla1: null");
            logger.trace(logPrfx + " <-- ");
            return isChanged;
        } else if (!Objects.equals(amtGenFmla1.getId2(), "Ref1 Mult Exch_Rate")) {
            logger.debug(logPrfx + " --- amtGenFmla1: " + amtGenFmla1.getId2());
            notifications.create().withCaption("amtGenFmla1_Id must be 'Ref1 Mult Exch_Rate' to get an exchange rate.").show();
            logger.trace(logPrfx + " <-- ");
            return isChanged;
        } else {
            logger.debug(logPrfx + " --- amtGenFmla1: " + amtGenFmla1.getId());
        }
    ...
    private Boolean updateAmtCalc(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        UsrItemGenFmla amtFinFmla1 = thisFinTxactItm.getAmtCalcGenFmla1_Id();
        if (amtFinFmla1 == null) {
    ...
    public UsrNodeBase getPrevFinTxactItm(@NotNull UsrNodeBase thisFinTxactItm) {
        ...
        if (thisFinTxactItm.getNm1s1Inst1Int3() != null || thisFinTxactItm.getNm1s1Inst1Int3() >= 1) {
            ...
            String qry = "select e from enty_UsrNodeFinTxactItm e"
                    + " where e.id2 = :id2";
