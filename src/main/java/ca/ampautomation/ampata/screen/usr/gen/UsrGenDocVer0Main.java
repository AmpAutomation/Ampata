...
public class UsrGenDocVer0Main extends UsrBaseNode0BaseMain<UsrGenDocVer, UsrGenDocVerType, UsrGenDocVerQryMngr, Table<UsrGenDocVer>> {
    ...
    public void onInit(InitEvent event) {
        ...
        colLoadrGenChan.setQuery("select e from enty_"+ UsrGenChan.class.getSimpleName() + " e order by e.sortKey, e.id2");
        ...
        colLoadrGenFile.setQuery("select e from enty_"+ UsrGenFile.class.getSimpleName() + " e order by e.sortKey, e.id2");
