...
public abstract class UsrBaseNode0BaseMain<NodeT extends UsrBaseNode, NodeTypeT extends UsrBaseNodeType, NodeQryMngrT extends UsrBaseQryMngr, TableT extends Table>  extends MasterDetailScreen<NodeT> {
    ...
    protected void updateHelper(List<UsrBaseNode> chngNodes) {
        String logPrfx = "updateHelper";
        logger.trace(logPrfx + " --> ");
