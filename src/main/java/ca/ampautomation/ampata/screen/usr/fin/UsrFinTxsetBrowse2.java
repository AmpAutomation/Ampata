...
@UiController("ampata_UsrFinTxset.browse2")
@UiDescriptor("usr-fin-txset-browse2.xml")
@LookupComponent("table")
public class UsrFinTxsetBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    @Autowired
    protected PropertyFilter<UsrNode> filterConfig1A_GenChan2_Id;
    ...
    @Autowired
    protected EntityComboBox<UsrNode> tmplt_GenChan2_IdField;
    ...
    @Autowired
    private InstanceContainer<UsrNode> finTxsetDc;
    ...
    @Autowired
    private EntityComboBox<UsrNode> genChan2_IdField;
    ...
    @Autowired
    private EntityComboBox<UsrNode> desc1FinTxactItm2_IdField;
    ...
    Logger logger = LoggerFactory.getLogger(UsrFinTxsetBrowse2.class);
    ...
    public void onInit(InitEvent event) {
        ...
        EntityComboBox<UsrNode> propFilterCmpnt_GenChan2_Id = (EntityComboBox<UsrNode>) filterConfig1A_GenChan2_Id.getValueComponent();
    ...
    */
    ...
    public void onInitEntity(InitEntityEvent<UsrNode> event) {
        ...
        UsrNode thisFinTxset = event.getEntity();
    ...
    */
    ...
    public void onFinTxactsDcItemChange(InstanceContainer.ItemChangeEvent<UsrNode> event) {
        ...
        UsrNode thisFinTxset = event.getItem();
        if (thisFinTxset == null) {
            logger.debug(logPrfx + " --- thisFinTxset is null, likely because no record is selected.");
            logger.trace(logPrfx + " <-- ");
            return;
    ...
    public void onUpdateColCalcValsBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing repo.execFinTxsetPrUpdNative()");
        repo.execFinTxsetPrUpdNative();
        logger.debug(logPrfx + " --- finished repo.execFinTxsetPrUpdNative()");
    ...
    public void onPurgeColBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing repo.execFinTxsetPrPurgeNative()");
        repo.execFinTxsetPrPurgeNative();
        logger.debug(logPrfx + " --- finished repo.execFinTxsetPrPurgeNative()");
    ...
    public void onDeleteColOrphansBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing repo.execFinTxsetPrDelOrphNative()");
        repo.execFinTxsetPrDelOrphNative();
        logger.debug(logPrfx + " --- finished repo.execFinTxsetPrDelOrphNative()");
    ...
    public void onDuplicateBtnClick(Button.ClickEvent event) {
        ...
        List<UsrNode> thisFinTxsets = table.getSelected().stream().toList();
    ...
    public void onUpdateInstItemValsBtnClick(Button.ClickEvent event) {
        ...
        UsrNode thisFinTxset = finTxsetDc.getItemOrNull();
        if (thisFinTxset == null) {
            logger.debug(logPrfx + " --- thisFinTxset is null, likely because no record is selected.");
            notifications.create().withCaption("No record selected. Please select a record.").show();
            logger.trace(logPrfx + " <-- ");
    ...
    private Boolean updateCalcVals(@NotNull UsrNode thisFinTxset) {
    ...
    private Boolean updateFinTxsetCalcVals(@NotNull UsrNode thisFinTxset) {
    ...
    private Boolean updateId2(@NotNull UsrNode thisFinTxset) {
    ...
    private Boolean updateId2Calc(UsrNode thisFinTxset){
        // Assume thisFinTxset is not null
    ...
    private Boolean updateId2Cmp(UsrNode thisFinTxset) {
        // Assume thisFinTxset is not null
    ...
    private Boolean updateId2Dup(UsrNode thisFinTxset) {
        // Assume thisFinTxset is not null
        ...
        if (thisFinTxset.getId2() != null) {
            String id2Qry = "select count(e) from ampata_UsrNode e where e.className = 'FinTxset' and e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try {
    ...
    private Boolean updateDesc1(@NotNull UsrNode thisFinTxset) {
        // Assume thisFinTxset is not null
    ...
    private Boolean updateIdDt(@NotNull UsrNode thisFinTxset) {
        // Assume thisFinTxset is not null
    ...
    private Boolean updateFinTxacts1_IdCntCalc(@NotNull UsrNode thisFinTxset) {
        ...
        String qry1 = "select count(e.id2) from ampata_UsrNode e where e.className = 'FinTxact' and e.finTxset1_Id = :finTxset1_Id";
        try{
