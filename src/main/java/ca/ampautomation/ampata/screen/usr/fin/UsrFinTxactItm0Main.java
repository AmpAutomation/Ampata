...
public class UsrFinTxactItm0Main extends MasterDetailScreen<UsrNodeBase> {
    ...
    @Autowired
    protected PropertyFilter<UsrFinAcct> filterConfig1A_FinAcct1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrGenTag> filterConfig1A_GenTag1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrFinTxactSetType> filterConfig1A_FinTxact1_Id_FinTxactSet1_Id_Type1_Id;

    @Autowired
    protected PropertyFilter<UsrGenChan> filterConfig1A_FinTxact1_Id_FinTxactSet1_Id_GenChan1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrGenTag> filterConfig1A_FinTxact1_Id_FinTxactSet1_Id_GenTag1_Id;

    
    //Filter (filterConfig1A.FinStmtItm)
    @Autowired
    protected PropertyFilter<UsrFinStmt> filterConfig1A_FinStmtItm1_Id_FinStmt1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrFinAcct> filterConfig1B_FinAcct1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrGenTag> filterConfig1B_GenTag1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrFinTxactSetType> filterConfig1B_FinTxact1_Id_FinTxactSet1_Id_type1_Id;

    @Autowired
    protected PropertyFilter<UsrGenChan> filterConfig1B_FinTxact1_Id_FinTxactSet1_Id_GenChan1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrGenTag> filterConfig1B_FinTxact1_Id_FinTxactSet1_Id_GenTag1_Id;


    //Filter (filterConfig1B.FinStmtItm)
    @Autowired
    protected PropertyFilter<UsrFinStmt> filterConfig1B_FinStmtItm1_Id_FinStmt1_Id;
    ...
    @Autowired
    protected EntityComboBox<UsrFinStmtItm> tmplt_FinStmtItm1_IdField;
    ...
    @Autowired
    protected EntityComboBox<UsrFinAcct> tmplt_FinAcct1_IdField;

    @Autowired
    protected CheckBox tmplt_FinAcct1_IdFieldChk;

    @Autowired
    protected EntityComboBox<UsrFinDept> tmplt_FinDept1_IdField;
    ...
    //Template (FinTxact)
    @Autowired
    protected EntityComboBox<UsrFinTxactType> tmplt_FinTxact1_Id_Type1_IdField;
    ...
    @Autowired
    protected EntityComboBox<UsrFinTxactSetType> tmplt_FinTxact1_Id_FinTxactSet1_Id_Type1_IdField;

    @Autowired
    protected CheckBox tmplt_FinTxact1_Id_FinTxactSet1_Id_Type1_IdFieldChk;

    @Autowired
    protected EntityComboBox<UsrGenChan> tmplt_FinTxact1_Id_FinTxactSet1_Id_GenChan1_IdField;
    ...
    private CollectionContainer<UsrFinTxact> colCntnrFinTxact;
    private CollectionLoader<UsrFinTxact> colLoadrFinTxact;

    private CollectionContainer<UsrFinTxactType> colCntnrFinTxactType;
    private CollectionLoader<UsrFinTxactType> colLoadrFinTxactType;

    private CollectionContainer<UsrFinTxact> colContnrFinTxact1_IdCandids;
    private CollectionLoader<UsrFinTxact> colLoadrFinTxact1_IdCandids;

    private CollectionContainer<UsrFinTxactSet> colCntnrFinTxactSet;
    private CollectionLoader<UsrFinTxactSet> colLoadrFinTxactSet;

    private CollectionContainer<UsrFinTxactSetType> colCntnrFinTxactSetType;
    private CollectionLoader<UsrFinTxactSetType> colLoadrFinTxactSetType;

    private CollectionContainer<UsrFinTxactSet> colCntnrFinTxactSet1_IdCandids;
    private CollectionLoader<UsrFinTxactSet> colLoadrFinTxactSet1_IdCandids;

    private CollectionContainer<UsrFinStmt> colCntnrFinStmt;
    private CollectionLoader<UsrFinStmt> colLoadrFinStmt;

    private CollectionContainer<UsrFinStmtItm> colCntnrFinStmtItm;
    private CollectionLoader<UsrFinStmtItm> colLoadrFinStmtItm;

    private CollectionContainer<UsrFinStmtItm> colCntnrFinStmtItm1_IdCandids;
    private CollectionLoader<UsrFinStmtItm> colLoadrFinStmtItm1_IdCandids;

    private CollectionContainer<UsrFinDept> colCntnrFinDept;
    private CollectionLoader<UsrFinDept> colLoadrFinDept;
    ...
    @Autowired
    private EntityComboBox<UsrFinStmtItm> finStmtItm1_IdField;

    @Autowired
    private Table<UsrFinStmtItm> tableFinStmtItm1_IdCandids;
    ...
    @Autowired
    private EntityComboBox<UsrFinAcct> finAcct1_IdField;
    ...
    //Field (FinTxact)
    @Autowired
    private EntityComboBox<UsrFinTxact> finTxact1_IdField;

    @Autowired
    private Table<UsrFinTxact> tableFinTxact1_IdCandids;

    @Autowired
    private EntityComboBox<UsrFinTxactType> finTxact1_Id_Type1_IdField;
    ...
    @Autowired
    private EntityComboBox<UsrFinTxactSet> finTxact1_Id_FinTxactSet1_IdField;

    @Autowired
    private Table<UsrFinTxactSet> tableFinTxact1_FinTxactSet1_IdCandids;

    @Autowired
    private EntityComboBox<UsrFinTxactSetType> finTxact1_Id_FinTxactSet1_Id_Type1_IdField;

    @Autowired
    private EntityComboBox<UsrGenChan> finTxact1_Id_FinTxactSet1_Id_GenChan1_IdField;

    @Autowired
    private EntityComboBox<UsrGenChan> finTxact1_Id_FinTxactSet1_Id_GenChan2_IdField;
    ...
    public void onInit(InitEvent event) {
        ...
        FetchPlan fchPlnGenChan = fetchPlans.builder(UsrGenChan.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        propFilterCmpnt_GenChan1_Id = (EntityComboBox<UsrGenChan>) filterConfig1A_FinTxact1_Id_FinTxactSet1_Id_GenChan1_Id.getValueComponent();
        propFilterCmpnt_GenChan1_Id.setOptionsContainer(colCntnrGenChan);
        propFilterCmpnt_GenChan1_Id = (EntityComboBox<UsrGenChan>) filterConfig1B_FinTxact1_Id_FinTxactSet1_Id_GenChan1_Id.getValueComponent();
        propFilterCmpnt_GenChan1_Id.setOptionsContainer(colCntnrGenChan);
        ...
        FetchPlan fchPlnFinHow = fetchPlans.builder(UsrFinHow.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        FetchPlan fchPlnFinWhat = fetchPlans.builder(UsrFinWhat.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        FetchPlan fchPlnFinWhy = fetchPlans.builder(UsrFinWhy.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        //filter
        EntityComboBox<UsrGenDocVer> propFilterCmpnt_GenDocVer1_Id;
        propFilterCmpnt_GenDocVer1_Id = (EntityComboBox<UsrGenDocVer>) filterConfig1A_GenDocVer1_Id.getValueComponent();
        propFilterCmpnt_GenDocVer1_Id.setOptionsContainer(colCntnrGenDocVer);
        propFilterCmpnt_GenDocVer1_Id = (EntityComboBox<UsrGenDocVer>) filterConfig1B_GenDocVer1_Id.getValueComponent();
        propFilterCmpnt_GenDocVer1_Id.setOptionsContainer(colCntnrGenDocVer);
        ...
        //filter
        EntityComboBox<UsrGenTag> propFilterCmpnt_GenTag1_Id;
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrGenTag>) filterConfig1A_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(colCntnrGenTag);
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrGenTag>) filterConfig1A_FinTxact1_Id_FinTxactSet1_Id_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(colCntnrGenTag);
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrGenTag>) filterConfig1B_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(colCntnrGenTag);
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrGenTag>) filterConfig1B_FinTxact1_Id_FinTxactSet1_Id_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(colCntnrGenTag);


        colCntnrFinTxact = dataComponents.createCollectionContainer(UsrFinTxact.class);
        ...
        FetchPlan fchPlnFinTxact = fetchPlans.builder(UsrFinTxact.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        colCntnrFinTxactType = dataComponents.createCollectionContainer(UsrFinTxactType.class);
        ...
        FetchPlan fchPlnFinTxactType = fetchPlans.builder(UsrFinTxactType.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        colContnrFinTxact1_IdCandids = dataComponents.createCollectionContainer(UsrFinTxact.class);
        colLoadrFinTxact1_IdCandids = dataComponents.createCollectionLoader();
        colLoadrFinTxact1_IdCandids.setQuery("select e from enty_UsrFinTxact e where e.id is null order by e.sortKey, e.id2");
        FetchPlan fchPlnFinTxactCandid = fetchPlans.builder(UsrFinTxact.class)
        ...
        colCntnrFinTxactSet = dataComponents.createCollectionContainer(UsrFinTxactSet.class);
        ...
        FetchPlan fchPlnFinTxactSet = fetchPlans.builder(UsrFinTxactSet.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        colCntnrFinTxactSetType = dataComponents.createCollectionContainer(UsrFinTxactSetType.class);
        ...
        FetchPlan fchPlnFinTxactSetType = fetchPlans.builder(UsrFinTxactSetType.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        //filter
        EntityComboBox<UsrFinTxactSetType> propFilterCmpnt_FinTxact1_Id_FinTxactSet1_Id_Type1_Id;
        propFilterCmpnt_FinTxact1_Id_FinTxactSet1_Id_Type1_Id = (EntityComboBox<UsrFinTxactSetType>) filterConfig1A_FinTxact1_Id_FinTxactSet1_Id_Type1_Id.getValueComponent();
        propFilterCmpnt_FinTxact1_Id_FinTxactSet1_Id_Type1_Id.setOptionsContainer(colCntnrFinTxactSetType);
        propFilterCmpnt_FinTxact1_Id_FinTxactSet1_Id_Type1_Id = (EntityComboBox<UsrFinTxactSetType>) filterConfig1B_FinTxact1_Id_FinTxactSet1_Id_type1_Id.getValueComponent();
        propFilterCmpnt_FinTxact1_Id_FinTxactSet1_Id_Type1_Id.setOptionsContainer(colCntnrFinTxactSetType);


        colCntnrFinTxactSet1_IdCandids = dataComponents.createCollectionContainer(UsrFinTxactSet.class);
        colLoadrFinTxactSet1_IdCandids = dataComponents.createCollectionLoader();
        colLoadrFinTxactSet1_IdCandids.setQuery("select e from enty_UsrFinTxactSet e where e.id is null order by e.sortKey, e.id2");
        FetchPlan fchPlnFinTxactSetCandid = fetchPlans.builder(UsrFinTxactSet.class)
        ...
        colCntnrFinStmt = dataComponents.createCollectionContainer(UsrFinStmt.class);
        ...
        FetchPlan fchPlnFinStmt = fetchPlans.builder(UsrFinStmt.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        //filter
        EntityComboBox<UsrFinStmt> propFilterCmpnt_FinStmt1_Id;
        propFilterCmpnt_FinStmt1_Id = (EntityComboBox<UsrFinStmt>) filterConfig1A_FinStmtItm1_Id_FinStmt1_Id.getValueComponent();
        propFilterCmpnt_FinStmt1_Id.setOptionsContainer(colCntnrFinStmt);
        propFilterCmpnt_FinStmt1_Id = (EntityComboBox<UsrFinStmt>) filterConfig1B_FinStmtItm1_Id_FinStmt1_Id.getValueComponent();
        propFilterCmpnt_FinStmt1_Id.setOptionsContainer(colCntnrFinStmt);


        colCntnrFinStmtItm = dataComponents.createCollectionContainer(UsrFinStmtItm.class);
        colLoadrFinStmtItm = dataComponents.createCollectionLoader();
        colLoadrFinStmtItm.setQuery("select e from enty_UsrFinStmtItm e order by e.sortKey, e.id2");
        FetchPlan fchPlnFinStmtItm = fetchPlans.builder(UsrFinStmtItm.class)
        ...
        colCntnrFinStmtItm1_IdCandids = dataComponents.createCollectionContainer(UsrFinStmtItm.class);
        colLoadrFinStmtItm1_IdCandids = dataComponents.createCollectionLoader();
        colLoadrFinStmtItm1_IdCandids.setQuery("select e from enty_UsrFinStmtItm e where e.id is null order by e.sortKey, e.id2");
        FetchPlan fchPlnFinStmtItmCandid = fetchPlans.builder(UsrFinStmtItm.class)
                .addFetchPlan("fetchPlan_UsrFinStmtItm_Base")
                .build();
        ...
        FetchPlan fchPlnFinTaxLne = fetchPlans.builder(UsrFinTaxLne.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        colCntnrFinAcct = dataComponents.createCollectionContainer(UsrFinAcct.class);
        ...
        FetchPlan fchPlnFinAcct = fetchPlans.builder(UsrFinAcct.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        //filter
        EntityComboBox<UsrFinAcct> propFilterCmpnt_FinAcct1_Id;
        propFilterCmpnt_FinAcct1_Id = (EntityComboBox<UsrFinAcct>) filterConfig1A_FinAcct1_Id.getValueComponent();
        propFilterCmpnt_FinAcct1_Id.setOptionsContainer(colCntnrFinAcct);
        propFilterCmpnt_FinAcct1_Id = (EntityComboBox<UsrFinAcct>) filterConfig1B_FinAcct1_Id.getValueComponent();
        propFilterCmpnt_FinAcct1_Id.setOptionsContainer(colCntnrFinAcct);


        colCntnrFinDept = dataComponents.createCollectionContainer(UsrFinDept.class);
        ...
        FetchPlan fchPlnFinDept = fetchPlans.builder(UsrFinDept.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        //filter
        EntityComboBox<UsrFinDept> propFilterCmpnt_FinDept1_Id;
        propFilterCmpnt_FinDept1_Id = (EntityComboBox<UsrFinDept>) filterConfig1A_FinDept1_Id.getValueComponent();
        propFilterCmpnt_FinDept1_Id.setOptionsContainer(colCntnrFinDept);
        propFilterCmpnt_FinDept1_Id = (EntityComboBox<UsrFinDept>) filterConfig1B_FinDept1_Id.getValueComponent();
        propFilterCmpnt_FinDept1_Id.setOptionsContainer(colCntnrFinDept);
        ...
        colCntnrFinTxactItm1 = dataComponents.createCollectionContainer(UsrFinTxactItm.class);
        ...
        FetchPlan fchPlnFinTxactItm1 = fetchPlans.builder(UsrFinTxactItm.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        ...
        FetchPlan fchPlnFinFmla = fetchPlans.builder(UsrFinFmla.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        colLoadrFinFmla.setFetchPlan(fchPlnFinFmla);
...
*/
    ...
    private void updateFinTxactItmHelper() {
        ...
        if(dataContext.hasChanges()) {
            ...
            thisFinTxactItms.forEach(thisFinTxactItm -> {
                //UsrFinTxactItm thisTrackedFinTxactItm = dataContext.merge(thisFinTxactItm);
                if (thisFinTxactItm != null) {
    ...
    public void onUpdateFinStmtItm1_IdFieldBtnClick(Button.ClickEvent event) {
        ...
        List<UsrFinStmtItm> finStmtItms = tableFinStmtItm1_IdCandids.getSelected().stream().toList();
        if (finStmtItms.size() > 0){
            UsrFinStmtItm finStmtItm = finStmtItms.get(0);
...
//        isChanged = updateFinStmtItm1_Id_Desc1(thisFinTxactItm) || isChanged;
    ...
    private UsrFinStmtItm findFinStmtItmEqId2(@NotNull String finStmtItm_Id2) {
        ...
        UsrFinStmtItm finStmtItm_Id = null;
        try {
            finStmtItm_Id = dataManager.load(UsrFinStmtItm.class)
                    .query(qry)
