...
//@PessimisticLock
@UiController("ampata_UsrFinTxactItm.browse2")
@UiDescriptor("usr-fin-txact-itm-browse2.xml")
@LookupComponent("table")
public class UsrFinTxactItmBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    @Autowired
    protected PropertyFilter<UsrNodeType> filterConfig1A_FinTxact1_Id_FinTxset1_Id_Type1_Id;

    @Autowired
    protected PropertyFilter<UsrNode> filterConfig1A_FinTxact1_Id_FinTxset1_Id_GenChan1_Id;

    @Autowired
    protected PropertyFilter<UsrFinHow> filterConfig1A_FinTxact1_Id_FinTxset1_Id_FinHow1_Id;

    @Autowired
    protected PropertyFilter<UsrFinWhat> filterConfig1A_FinTxact1_Id_FinTxset1_Id_FinWhat1_Id;

    @Autowired
    protected PropertyFilter<UsrFinWhy> filterConfig1A_FinTxact1_Id_FinTxset1_Id_FinWhy1_Id;

    @Autowired
    protected PropertyFilter<UsrNode> filterConfig1A_FinTxact1_Id_FinTxset1_Id_GenTag1_Id;
    ...
    @Autowired
    protected PropertyFilter<UsrNodeType> filterConfig1B_FinTxact1_Id_FinTxset1_Id_type1_Id;

    @Autowired
    protected PropertyFilter<UsrNode> filterConfig1B_FinTxact1_Id_FinTxset1_Id_GenChan1_Id;

    @Autowired
    protected PropertyFilter<UsrFinHow> filterConfig1B_FinTxact1_Id_FinTxset1_Id_FinHow1_Id;

    @Autowired
    protected PropertyFilter<UsrFinWhat> filterConfig1B_FinTxact1_Id_FinTxset1_Id_FinWhat1_Id;

    @Autowired
    protected PropertyFilter<UsrFinWhy> filterConfig1B_FinTxact1_Id_FinTxset1_Id_FinWhy1_Id;

    @Autowired
    protected PropertyFilter<UsrNode> filterConfig1B_FinTxact1_Id_FinTxset1_Id_GenTag1_Id;
    ...
    //FinTxset tmplt
    @Autowired
    protected EntityComboBox<UsrNodeType> tmplt_FinTxact1_Id_FinTxset1_Id_Type1_IdField;

    @Autowired
    protected CheckBox tmplt_FinTxact1_Id_FinTxset1_Id_Type1_IdFieldChk;

    @Autowired
    protected EntityComboBox<UsrNode> tmplt_FinTxact1_Id_FinTxset1_Id_GenChan1_IdField;

    @Autowired
    protected CheckBox tmplt_FinTxact1_Id_FinTxset1_Id_GenChan1_IdFieldChk;

    @Autowired
    protected EntityComboBox<UsrFinHow> tmplt_FinTxact1_Id_FinTxset1_Id_FinHow1_IdField;
    ...
    @Autowired
    protected EntityComboBox<UsrFinWhat> tmplt_FinTxact1_Id_FinTxset1_Id_FinWhat1_IdField;
    ...
    @Autowired
    protected EntityComboBox<UsrFinWhy> tmplt_FinTxact1_Id_FinTxset1_Id_FinWhy1_IdField;
    ...
    private CollectionContainer<UsrNode> finTxact1_IdCandidsDc;

    private CollectionLoader<UsrNode> finTxact1_IdCandidsDl;
    ...
    private CollectionContainer<UsrNode> finTxset1_IdCandidsDc;

    private CollectionLoader<UsrNode> finTxset1_IdCandidsDl;
    ...
    private CollectionContainer<UsrNode> finStmtItm1_IdCandidsDc;

    private CollectionLoader<UsrNode> finStmtItm1_IdCandidsDl;
    ...
    @Autowired
    private Table<UsrNode> finStmtItm1_IdCandidsTable;
    ...
    @Autowired
    private Table<UsrNode> finTxact1_IdCandidsTable;
    ...
    @Autowired
    private EntityComboBox<UsrGenPat> finTxact1_Id_Desc1UsrNode1_IdField;
    ...
    @Autowired
    private Table<UsrNode> finTxact1_Id_FinTxset1_IdCandidsTable;
    ...
    @Autowired
    private EntityComboBox<UsrNode> finTxact1_Id_FinTxset1_Id_GenChan2_IdField;
    ...
    @Autowired
    private EntityComboBox<UsrGenPat> finTxact1_Id_FinTxset1_Id_Desc1UsrNode1_IdField;

    @Autowired
    private EntityComboBox<UsrNode> finTxact1_Id_FinTxset1_Id_Desc1FinTxactItm1_IdField;

    @Autowired
    private EntityComboBox<UsrNode> finTxact1_Id_FinTxset1_Id_Desc1FinTxactItm2_IdField;

    @Autowired
    private EntityComboBox<UsrNode> finTxact1_Id_FinTxset1_Id_GenTag1_IdField;
    ...
    public void onInit(InitEvent event) {
        ...
        propFilterCmpnt_GenChan1_Id = (EntityComboBox<UsrNode>) filterConfig1A_FinTxact1_Id_FinTxset1_Id_GenChan1_Id.getValueComponent();
        propFilterCmpnt_GenChan1_Id.setOptionsContainer(genChansDc);
        propFilterCmpnt_GenChan1_Id = (EntityComboBox<UsrNode>) filterConfig1B_FinTxact1_Id_FinTxset1_Id_GenChan1_Id.getValueComponent();
        propFilterCmpnt_GenChan1_Id.setOptionsContainer(genChansDc);
        ...
        propFilterCmpnt_FinHow1_Id = (EntityComboBox<UsrFinHow>) filterConfig1A_FinTxact1_Id_FinTxset1_Id_FinHow1_Id.getValueComponent();
        propFilterCmpnt_FinHow1_Id.setOptionsContainer(finHowsDc);
        propFilterCmpnt_FinHow1_Id = (EntityComboBox<UsrFinHow>) filterConfig1B_FinTxact1_Id_FinTxset1_Id_FinHow1_Id.getValueComponent();
        propFilterCmpnt_FinHow1_Id.setOptionsContainer(finHowsDc);
        ...
        propFilterCmpnt_FinWhat1_Id = (EntityComboBox<UsrFinWhat>) filterConfig1A_FinTxact1_Id_FinTxset1_Id_FinWhat1_Id.getValueComponent();
        propFilterCmpnt_FinWhat1_Id.setOptionsContainer(finWhatsDc);
        propFilterCmpnt_FinWhat1_Id = (EntityComboBox<UsrFinWhat>) filterConfig1B_FinTxact1_Id_FinTxset1_Id_FinWhat1_Id.getValueComponent();
        propFilterCmpnt_FinWhat1_Id.setOptionsContainer(finWhatsDc);
        ...
        propFilterCmpnt_FinWhy1_Id = (EntityComboBox<UsrFinWhy>) filterConfig1A_FinTxact1_Id_FinTxset1_Id_FinWhy1_Id.getValueComponent();
        propFilterCmpnt_FinWhy1_Id.setOptionsContainer(finWhysDc);
        propFilterCmpnt_FinWhy1_Id = (EntityComboBox<UsrFinWhy>) filterConfig1B_FinTxact1_Id_FinTxset1_Id_FinWhy1_Id.getValueComponent();
        propFilterCmpnt_FinWhy1_Id.setOptionsContainer(finWhysDc);
        ...
        finTxact1_Id_Desc1UsrNode1_IdField.setOptionsContainer(genPatsDc);
        finTxact1_Id_FinTxset1_Id_Desc1UsrNode1_IdField.setOptionsContainer(genPatsDc);
        ...
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrNode>) filterConfig1A_FinTxact1_Id_FinTxset1_Id_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(genTagsDc);
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrNode>) filterConfig1B_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(genTagsDc);
        propFilterCmpnt_GenTag1_Id = (EntityComboBox<UsrNode>) filterConfig1B_FinTxact1_Id_FinTxset1_Id_GenTag1_Id.getValueComponent();
        propFilterCmpnt_GenTag1_Id.setOptionsContainer(genTagsDc);
        ...
        finTxact1_IdCandidsDc = dataComponents.createCollectionContainer(UsrNode.class);
        finTxact1_IdCandidsDl = dataComponents.createCollectionLoader();
        finTxact1_IdCandidsDl.setQuery("select e from ampata_UsrNode e where e.className = 'FinTxact' and e.id is null order by e.id2");
        FetchPlan finTxactCandidsFp = fetchPlans.builder(UsrNode.class)
                .addFetchPlan("usrFinTxact-fetch-plan-base")
                .build();
        ...
        //filter
        EntityComboBox<UsrNodeType> propFilterCmpnt_FinTxact1_Id_FinTxset1_Id_Type1_Id;
        propFilterCmpnt_FinTxact1_Id_FinTxset1_Id_Type1_Id = (EntityComboBox<UsrNodeType>) filterConfig1A_FinTxact1_Id_FinTxset1_Id_Type1_Id.getValueComponent();
        propFilterCmpnt_FinTxact1_Id_FinTxset1_Id_Type1_Id.setOptionsContainer(finTxsetTypesDc);
        propFilterCmpnt_FinTxact1_Id_FinTxset1_Id_Type1_Id = (EntityComboBox<UsrNodeType>) filterConfig1B_FinTxact1_Id_FinTxset1_Id_type1_Id.getValueComponent();
        propFilterCmpnt_FinTxact1_Id_FinTxset1_Id_Type1_Id.setOptionsContainer(finTxsetTypesDc);


        finTxset1_IdCandidsDc = dataComponents.createCollectionContainer(UsrNode.class);
        finTxset1_IdCandidsDl = dataComponents.createCollectionLoader();
        finTxset1_IdCandidsDl.setQuery("select e from ampata_UsrNode e where e.className = 'FinTxset' and e.id is null order by e.id2");
        FetchPlan finTxsetCandidsFp = fetchPlans.builder(UsrNode.class)
                .addFetchPlan("usrFinTxset-fetch-plan-base")
                .build();
        ...
        finStmtItmsDc = dataComponents.createCollectionContainer(UsrNode.class);
        finStmtItmsDl = dataComponents.createCollectionLoader();
        finStmtItmsDl.setQuery("select e from ampata_UsrNode e where e.className = 'FinStmtItm' order by e.id2");
        FetchPlan finStmtItmsFp = fetchPlans.builder(UsrNode.class)
                .addFetchPlan("usrFinStmtItm-fetch-plan-base")
                .build();
        ...
        finStmtItm1_IdCandidsDc = dataComponents.createCollectionContainer(UsrNode.class);
        finStmtItm1_IdCandidsDl = dataComponents.createCollectionLoader();
        finStmtItm1_IdCandidsDl.setQuery("select e from ampata_UsrNode e where e.className = 'FinStmtItm' and e.id is null order by e.id2");
        ...
        sysFinCurcysDl.setQuery("select e from ampata_SysNode e where e.className = 'FinCurcy' order by e.id2");
...
*/
    ...
    public void onUpdateColCalcValsBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- calling repo.execNodePrUpdNative()");
        repo.execNodePrUpdNative();
        logger.debug(logPrfx + " --- finished repo.execNodePrUpdNative()");

        logger.debug(logPrfx + " --- calling repo.execFinTxactItmPrUpdNative()");
        repo.execFinTxactItmPrUpdNative();
        logger.debug(logPrfx + " --- finished repo.execFinTxactItmPrUpdNative()");

        logger.debug(logPrfx + " --- calling finTxactItmsDl.load()");
        finTxactItmsDl.load();
    ...
    public void onPurgeColBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing repo.execFinTxactItmPrPurgeNative()");
        repo.execFinTxactItmPrPurgeNative();
        logger.debug(logPrfx + " --- finished repo.execFinTxactItmPrPurgeNative()");
    ...
    public void onDeleteColOrphansBtnClick(Button.ClickEvent event) {
        ...
        logger.debug(logPrfx + " --- executing repo.execFinTxactItmPrDelOrphNative()");
        repo.execFinTxactItmPrDelOrphNative();
        logger.debug(logPrfx + " --- finished repo.execFinTxactItmPrDelOrphNative()");
    ...
    public void onSplitBtnClick(Button.ClickEvent event) {
        ...
        List<UsrNode> thisFinTxactItms = table.getSelected().stream().toList();
        ...
        thisFinTxactItms.forEach(thisFinTxactItm -> {
            if (thisFinTxactItm != null) {
                ...
                if (idDt1 != null){
                    ...
                    Integer idZMax = 0;
                    String idZMaxQry = "select max(e.idZ) from ampata_UsrNode e"
                            + " where e.className = 'FinTxactItm'"
                            + " and e.idDt.date1 = :idDt1";
                    try {
    ...
    public void onUpdateFinStmtItm1_IdFieldBtnClick(Button.ClickEvent event) {
        ...
        List<UsrNode> finStmtItms = finStmtItm1_IdCandidsTable.getSelected().stream().toList();
    ...
    private Boolean updateCalcVals(@NotNull UsrNode thisFinTxactItm, Integer finTxactOption, Integer finTxsetOption, Integer finStmtItmOption) {
...
//        isChanged = updateFinStmtItm1_Id_Desc1(thisFinTxactItm) || isChanged;
    ...
    private Boolean updateDesc1(@NotNull UsrNode thisFinTxactItm) {
        ...
        if (thisFinTxactItm.getSysFinCurcy1_Id() != null) {
            thisAmt = thisAmt + " " + Objects.toString(thisFinTxactItm.getSysFinCurcy1_Id().getId2(), "");
        }
        if (!thisAmt.equals("")) {
        ...
        UsrNode thisFinStmtItm = thisFinTxactItm.getFinStmtItm1_Id();
    ...
    private void updateFinTxact1_IdCandidsTable(@NotNull UsrNode thisFinTxactItm){
        ...
        finTxact1_IdCandidsDl.setQuery("select e from ampata_UsrNode e "
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_FinCurcyEqCalc(@NotNull UsrNode thisFinTxactItm) {
        ...
        String qry1 = "select e.sysFinCurcy1_Id from ampata_UsrNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id";
        try{
    ...
    private void updateFinStmtItm1_IdCandidsTable(@NotNull UsrNode thisFinTxactItm){
        ...
        finStmtItm1_IdCandidsDl.setQuery("select e from ampata_UsrNode e "
    ...
    private void updateFinTxact1_Id_FinTxset1_IdCandidsTable(@NotNull UsrNode thisFinTxactItm){
        String logPrfx = "updateFinTxact1_Id_FinTxset1_IdCandidsTable";
        logger.trace(logPrfx + " --> ");

        finTxset1_IdCandidsDl.setQuery("select e from ampata_UsrNode e "
    ...
    private UsrNode findFinTxsetEqId2(@NotNull String finTxset_Id2) {
    ...
    private Integer getIdZMax(LocalDate idDt1, Integer idX, Integer idY) {
        ...
        String idZCntIsNullQry = "select count(e) from ampata_UsrNode e"
                + " where e.className = 'FinTxactItm'"
                + " and e.idDt.date1 = :idDt1"
                + " and e.idX = :idX"
                + " and e.idX = :idY"
