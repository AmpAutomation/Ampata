...
@UiController("ampata_UsrFinStmt.browse2")
@UiDescriptor("usr-fin-stmt-browse2.xml")
@LookupComponent("table")
public class UsrFinStmtBrowse2 extends MasterDetailScreen<UsrNode> {
    ...
    Logger logger = LoggerFactory.getLogger(UsrFinStmtBrowse2.class);
