...
@UiDescriptor("usr-fin-txact-set-main.xml")
@LookupComponent("tableMain")
public class UsrFinTxactSetMain extends MasterDetailScreen<UsrNode> {
    ...
    public void onInit(InitEvent event) {
        ...
        colLoadrType.setQuery("select e from enty_UsrNodeType e where e.className = 'UsrFinTxactSet' order by e.id2");
        FetchPlan finTxactSetTypesFp = fetchPlans.builder(UsrNodeType.class)
                .addFetchPlan(FetchPlan.INSTANCE_NAME)
                .build();
        colLoadrType.setFetchPlan(finTxactSetTypesFp);
    ...
    */
    ...
    public void onInitEntity(InitEntityEvent<UsrNode> event) {
        ...
        UsrNode thisFinTxactSet = event.getEntity();
    ...
    */
    ...
    public void onFinTxactsDcItemChange(InstanceContainer.ItemChangeEvent<UsrNode> event) {
        ...
        UsrNode thisFinTxactSet = event.getItem();
        if (thisFinTxactSet == null) {
            logger.debug(logPrfx + " --- thisFinTxactSet is null, likely because no record is selected.");
            logger.trace(logPrfx + " <-- ");
            return;
    ...
    public void onDuplicateBtnClick(Button.ClickEvent event) {
        ...
        List<UsrNode> thisFinTxactSets = tableMain.getSelected().stream().toList();
    ...
    private Boolean updateCalcVals(@NotNull UsrNode thisFinTxactSet) {
    ...
    private Boolean updateFinTxactSetCalcVals(@NotNull UsrNode thisFinTxactSet) {
    ...
    private Boolean updateId2(@NotNull UsrNode thisFinTxactSet) {
    ...
    private Boolean updateId2Calc(UsrNode thisFinTxactSet){
        // Assume thisFinTxactSet is not null
    ...
    private Boolean updateId2Cmp(UsrNode thisFinTxactSet) {
        // Assume thisFinTxactSet is not null
    ...
    private Boolean updateId2Dup(UsrNode thisFinTxactSet) {
        // Assume thisFinTxactSet is not null
        ...
        if (thisFinTxactSet.getId2() != null) {
            String id2Qry = "select count(e) from enty_UsrNode e where e.className = 'UsrFinTxactSet' and e.id2 = :id2 and e.id <> :id";
            Integer id2Dup;
            try {
    ...
    private Boolean updateDesc1(@NotNull UsrNode thisFinTxactSet) {
        // Assume thisFinTxactSet is not null
    ...
    private Boolean updateIdDt(@NotNull UsrNode thisFinTxactSet) {
        // Assume thisFinTxactSet is not null
    ...
    private Boolean updateFinTxacts1_IdCntCalc(@NotNull UsrNode thisFinTxactSet) {
        ...
        String qry1 = "select count(e.id2) from enty_UsrNode e where e.className = 'UsrFinTxact' and e.finTxactSet1_Id = :finTxactSet1_Id";
        try{
