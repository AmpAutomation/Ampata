...
public class FinTxactItmEdit extends StandardEditor<GenNode> {
    ...
    */
    ...
    private Boolean updateCalcVals(@NotNull GenNode thisFinTxactItm, Integer finTxactOption, Integer finTxsetOption) {
...
//        isChanged = updateFinTaxLne1_Id(thisFinTxactItm) || isChanged;
    ...
    private Boolean updateDesc1(@NotNull GenNode thisFinTxactItm) {
        ...
        if (thisFinTxactItm.getFinCurcy1_Id() != null) {
            thisCurcy = Objects.toString(thisFinTxactItm.getFinCurcy1_Id().getId2(), "");
        }
            ...
            if (thisFinTxset.getDesc1GenPat1_Id() == null) {
                ...
                if (desc1FinTxactItm1 != null) {
                    if (desc1FinTxactItm1.getFinCurcy1_Id() != null) {
                        thisCurcy = Objects.toString(desc1FinTxactItm1.getFinCurcy1_Id().getId2(), "");
                    }
                }
                logger.debug(logPrfx + " --- thisCurcy: " + thisCurcy);
    ...
    private Boolean updateIdTs(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_AmtDebtSumCalc(@NotNull GenNode thisFinTxactItm) {
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select sum(e.amtDebt) from ampata_GenNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id";
            try{
    ...
    private GenNode findFinTxactItmById2(@NotNull String finTxactItm_Id2) {
