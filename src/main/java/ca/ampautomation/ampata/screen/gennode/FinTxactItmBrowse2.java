...
public class FinTxactItmBrowse2 extends MasterDetailScreen<GenNode> {
    ...
    @Autowired
    protected PropertyFilter<GenNode> filterConfig1B_finCurcy1_Id;
    ...
    @Autowired
    private InstanceContainer<GenNode> finTxactItmDc;

    private CollectionContainer<GenNodeType> finTxactItmTypesDc;

    private CollectionLoader<GenNodeType> finTxactItmTypesDl;
    ...
    @Autowired
    private EntityComboBox<GenNode> amtFinTxactItm1_IdField;
    ...
    @Autowired
    private EntityComboBox<GenNode> finTxact1_Id_Desc1FinTxactItm1_IdField;
    ...
    @Autowired
    private EntityComboBox<GenNode> finTxact1_Id_FinTxset1_Id_Desc1FinTxactItm1_IdField;

    @Autowired
    private EntityComboBox<GenNode> finTxact1_Id_FinTxset1_Id_Desc1FinTxactItm2_IdField;
    ...
    public void onInit(InitEvent event) {
        ...
        finTxactItmTypesDc = dataComponents.createCollectionContainer(GenNodeType.class);
        finTxactItmTypesDl = dataComponents.createCollectionLoader();
        finTxactItmTypesDl.setQuery("select e from ampata_GenNodeType e where e.className = 'FinTxactItm' order by e.id2");
        FetchPlan finTxactItmTypesFp = fetchPlans.builder(GenNodeType.class)
        ...
        //filter
        EntityComboBox<GenNode> propFilterCmpnt_finCurcy1_Id;
        propFilterCmpnt_finCurcy1_Id = (EntityComboBox<GenNode>) filterConfig1A_finCurcy1_Id.getValueComponent();
        propFilterCmpnt_finCurcy1_Id.setOptionsContainer(finCurcysDc);
        propFilterCmpnt_finCurcy1_Id = (EntityComboBox<GenNode>) filterConfig1B_finCurcy1_Id.getValueComponent();
        propFilterCmpnt_finCurcy1_Id.setOptionsContainer(finCurcysDc);
    ...
    */
    ...
    public void onInitEntity(InitEntityEvent<GenNode> event) {
        ...
        GenNode thisFinTxactItm = event.getEntity();
    ...
    */
    ...
    public void onFinTxactItmsDcItemChange(InstanceContainer.ItemChangeEvent<GenNode> event) {
        String logPrfx = "onFinTxactItmsDcItemChange";
        logger.trace(logPrfx + " --> ");

        GenNode thisFinTxactItm = event.getItem();
        if (thisFinTxactItm == null) {
            logger.debug(logPrfx + " --- thisFinTxactItm is null, likely because no record is selected.");
            logger.trace(logPrfx + " <-- ");
            return;
...
*/
    ...
    public void onSetBtnClick(Button.ClickEvent event) {
        ...
        thisFinTxactItms.forEach(thisFinTxactItm -> {
            ...
            if (thisFinTxactItm != null) {
                ...
                GenNode thisFinTxact = thisFinTxactItm.getFinTxact1_Id();
                ...
                GenNode thisFinTxset = thisFinTxactItm.getFinTxact1_Id() == null ? null : thisFinTxactItm.getFinTxact1_Id().getFinTxset1_Id();
    ...
    public void onUpdateFilterConfig1B_IdDtGEBtnClick(Button.ClickEvent event) {
        ...
        switch (idDtGEOption) {
            ...
            case 1 -> {  // Set to match current row
                ...
                GenNode thisFinTxactItm = thisFinTxactItms.get(0);
                if (thisFinTxactItm != null) {
    ...
    public void onLinkAsRef1BtnClick(Button.ClickEvent event) {
        ...
        GenNode selFinTxactItm0Tracked = dataContext.merge(thisFinTxactItms.get(0));
        GenNode selFinTxactItm1Tracked = dataContext.merge(thisFinTxactItms.get(1));
    ...
    public void onUpdateInstIdPartsBtnClick(Button.ClickEvent event) {
        ...
        GenNode thisFinTxactItm = finTxactItmDc.getItemOrNull();
        if (thisFinTxactItm == null) {
            logger.debug(logPrfx + " --- thisFinTxactItm is null, likely because no record is selected.");
            notifications.create().withCaption("No record selected. Please select a record.").show();
            logger.trace(logPrfx + " <-- ");
    ...
    private Boolean updateCalcVals(@NotNull GenNode thisFinTxactItm, Integer finTxactOption, Integer finTxsetOption, Integer finStmtItmOption) {
    ...
    private Boolean updateFinTxactItmCalcVals(@NotNull GenNode thisFinTxactItm, Integer finTxactOption) {
...
//        isChanged = updateFinTaxLne1_Id(thisFinTxactItm) || isChanged;
    ...
    private Boolean updateFinTxactCalcVals(@NotNull GenNode thisFinTxactItm, Integer finTxsetOption) {
    ...
    private Boolean updateFinTxsetCalcVals(@NotNull GenNode thisFinTxactItm) {
    ...
    private Boolean updateFinStmtItmCalcVals(@NotNull GenNode thisFinTxactItm, Integer finStmtItmOption) {
...
//        isChanged = updateFinStmtItm1_Id_Desc1(thisFinTxactItm) || isChanged;
    ...
    private Boolean updateIdParts(@NotNull GenNode thisFinTxactItm) {
    ...
    private Boolean updateId2(@NotNull GenNode thisFinTxactItm) {
    ...
    private Boolean updateId2Calc(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateId2Cmp(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateId2Dup(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        if (thisFinTxactItm.getId2() != null) {
            String id2Qry = "select count(e) from ampata_GenNode e where e.className = 'FinTxactItm' and e.id2 = :id2 and e.id <> :id";
            int id2Dup;
            try {
    ...
    private Boolean updateDesc1(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        GenNode thisFinStmtItm = thisFinTxactItm.getFinStmtItm1_Id();
    ...
    private Boolean updateFinTxact1_Id_Desc1(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        if (thisFinTxact != null) {
            ...
            if (thisFinTxact != null) {
                ...
                GenNode desc1FinTxactItm1 = thisFinTxact.getDesc1FinTxactItm1_Id() == null
    ...
    private Boolean updateFinTxact1_Id_FinTxset1_Id_Desc1(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateIdDt(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateBeg1(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateBeg2(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateIdX(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateIdY(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateIdZ(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateFinStmtItm1_Id(@NotNull GenNode thisFinTxactItm, Integer finStmtItmOption) {
        // Assume thisFinTxactItm is not null
        String logPrfx = "updateFinStmtItm1_Id";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;
        GenNode finStmtItm1_Id_ = thisFinTxactItm.getFinTxact1_Id();
    ...
    private Boolean updateFinTxact1_Id(@NotNull GenNode thisFinTxactItm, Integer finTxactOption) {
        // Assume thisFinTxactItm is not null
        String logPrfx = "updateFinTxact1_Id";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;
        GenNode finTxact1_Id_ = thisFinTxactItm.getFinTxact1_Id();
    ...
    private void updateFinTxact1_IdCandidsTable(@NotNull GenNode thisFinTxactItm){
    ...
    private Boolean updateFinTxact1_Id2Trgt(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_IdCntCalc(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select count(e.amtNet) from ampata_GenNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id group by e.finTxact1_Id";
            try{
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_AmtDebtSumCalc(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select sum(e.amtDebt) from ampata_GenNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id group by e.finTxact1_Id";
            try{
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_AmtCredSumCalc(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        if (thisFinTxact != null) {
            ...
            String qry1 = "select sum(e.amtCred) from ampata_GenNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id group by e.finTxact1_Id";
            try{
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_AmtEqCalc(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateFintxact1_Id_FinTxactItms1_FinCurcyEqCalc(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
        ...
        String qry1 = "select e.finCurcy1_Id from ampata_GenNode e where e.className = 'FinTxactItm' and e.finTxact1_Id = :finTxact1_Id";
        try{
    ...
    private void updateFinStmtItm1_IdCandidsTable(@NotNull GenNode thisFinTxactItm){
        ...
        finStmtItm1_IdCandidsDl.setQuery("select e from ampata_GenNode e "
                ...
                + "order by e.id2");
        GenNode finAcct1 = thisFinTxactItm.getFinAcct1_Id();
        if (finAcct1 == null) {
    ...
    private Boolean updateFinStmtItm1_Id2Trgt(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private GenNode findFinTxactItmEqId2(@NotNull String finTxactItm_Id2) {
        ...
        String qry = "select e from ampata_GenNode e where e.className = 'FinTxactItm' and e.id2 = :id2";
    ...
    private GenNode createFinTxactFrFinTxactItm(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateFinTxact1_FinTxset1_Id(@NotNull GenNode thisFinTxactItm, Integer finTxsetOption) {
        // Assume thisFinTxactItm is not null
    ...
    private void updateFinTxact1_Id_FinTxset1_IdCandidsTable(@NotNull GenNode thisFinTxactItm){
    ...
    private Boolean updateFinTxact1_FinTxset1_Id2Trgt(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private GenNode createFinTxsetFrFinTxactItm(@NotNull GenNode thisFinTxactItm) {
        // Assume thisFinTxactItm is not null
    ...
    private Boolean updateAmtFinTxactItm1_EI1_Rate(@NotNull GenNode thisFinTxactItm) {
        //Assume thisFinTxactItm is not null
        ...
        GenNode amtFinTxactItm1 = thisFinTxactItm.getAmtFinTxactItm1_Id();
        ...
        GenNode curcyFr = thisFinTxactItm.getAmtFinTxactItm1_Id().getFinCurcy1_Id();
        if (curcyFr == null) {
        ...
        GenNode curcyTo = thisFinTxactItm.getFinCurcy1_Id();
        if (curcyTo == null) {
    ...
    private Boolean updateAmtCalc(@NotNull GenNode thisFinTxactItm) {
        //Assume thisFinTxactItm is not null
        ...
        GenNode prev1FinTxactItm;
        GenNode prev2FinTxactItm;
    ...
    public Boolean updateAmtNet(@NotNull GenNode thisFinTxactItm) {
        //Assume thisFinTxactItm is not null
        ...
        GenNode thisFinAcct = thisFinTxactItm.getFinAcct1_Id();
        if (thisFinAcct == null) {
    ...
    private Boolean updateFinTaxLne1_Id(@NotNull GenNode thisFinTxactItm) {
        //Assume thisFinTxactItm is not null
        String logPrfx = "updateFinTaxLne1_Id";
        logger.trace(logPrfx + " --> ");

        boolean isChanged = false;
        GenNode finTaxLne_ = thisFinTxactItm.getFinTaxLne1_Id();
        GenNode finTaxLne = thisFinTxactItm.getFinAcct1_Id() == null ? null :
    ...
    public GenNode getPrevFinTxactItm(@NotNull GenNode thisFinTxactItm) {
        //Assume thisFinTxactItm is not null
        String logPrfx = "getPrevFinTxactItm";
        logger.trace(logPrfx + " --> ");

        GenNode prevFinTxactItm = null;
        boolean qryRsltGood = false;
        ...
        if (thisFinTxactItm.getIdZ() != null || thisFinTxactItm.getIdZ() >= 1) {
            ...
            try {
                prevFinTxactItm = dataManager.load(GenNode.class)
                        .query(qry)
