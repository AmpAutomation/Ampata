...
public class SysFinCurcyExchRateMain extends SysNodeBaseMain<SysFinCurcyExchRate, SysFinCurcyExchRateType, SysFinCurcyExchRateQryMngr> {
    ...
    public void onDeriveBtnClick(Button.ClickEvent event) {
        ...
        thisFinCurcyExchRate.forEach(orig -> {
            ...
            if (tmplt_Ts1ElTsFieldChk.isChecked()) {
                ts1.setElTs(tmplt_Beg1Ts1Field.getValue());
