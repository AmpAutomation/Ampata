...
where
	t.class_name = 'UsrNodeFinStmtItm'
;
...
where class_name = 'UsrNodeFinStmtItm'
;	
...
where t2a.class_name = 'UsrNodeFinStmtItm'
and t2a.deleted_by IS null
and t2b.class_name = 'UsrNodeFinStmt'
and t2c.class_name = 'UsrNodeFinAcct'

) t1
where t.id = t1.id
and t.class_name = 'UsrNodeFinStmtItm'
...
from cte1 ct
where t.id = ct.id
and	t.class_name = 'UsrFinStmtItm'
and t.deleted_by is null
;
