drop function if exists Usr_Fin_Txset_Fn_get_Id2_Calc;

create function Usr_Fin_Txset_Fn_get_Id2_Calc(date1 date, i_x int) returns text
AS $$
...
select 
	 Usr_Fin_Txset_Fn_get_Id2_Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,1) as id1
	,Usr_Fin_Txset_Fn_get_Id2_Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,null) as id2
;
