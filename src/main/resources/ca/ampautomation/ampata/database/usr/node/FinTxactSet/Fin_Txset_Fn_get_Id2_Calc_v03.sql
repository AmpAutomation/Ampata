drop function if exists Fin_Txset_Fn_get_Id2_Calc;

create function Fin_Txset_Fn_get_Id2_Calc(ts1 timestamp, i_x int) returns text
AS $$
...
select 
	 Fin_Txset_Fn_get_Id2_Calc(TO_TIMESTAMP('2021-01-01 04:05:06', 'YYYY-MM-DD HH24:MI:ss')::timestamp,1) as id1
	,Fin_Txset_Fn_get_Id2_Calc(TO_TIMESTAMP('2021-01-01 04:05:06', 'YYYY-MM-DD HH24:MI:ss')::timestamp,null) as id2
;
