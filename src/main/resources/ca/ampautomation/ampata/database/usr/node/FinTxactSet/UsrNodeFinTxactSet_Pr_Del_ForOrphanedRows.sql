...
drop procedure if exists UsrNodeFinTxactSet_Pr_Del_ForOrphanedRows;


create procedure UsrNodeFinTxactSet_Pr_Del_ForOrphanedRows()
language 'plpgsql'
as $BODY$
declare
...
call UsrNodeFinTxactSet_Pr_Del_ForOrphanedRows();
