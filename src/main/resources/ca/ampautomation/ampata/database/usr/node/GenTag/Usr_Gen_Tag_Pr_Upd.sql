...
drop procedure if exists Usr_Gen_Tag_Pr_Upd;

create procedure Usr_Gen_Tag_Pr_Upd()
language 'plpgsql'
as $BODY$
declare
	rec_tenant record;
...
from (
	...
	where t2a.dtype = 'enty_UsrGenTag'
