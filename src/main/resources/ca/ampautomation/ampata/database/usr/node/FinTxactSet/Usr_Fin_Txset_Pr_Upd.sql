...
drop procedure if exists Usr_Fin_Txset_Pr_Upd;

create procedure Usr_Fin_Txset_Pr_Upd()
language 'plpgsql'
as $BODY$
declare
	rec_tenant record;
...
from (
	...
	where t2a.class_name = 'FinTxset'
	and t2a.deleted_by is null
	and t2b.class_name = 'FinTxset'
