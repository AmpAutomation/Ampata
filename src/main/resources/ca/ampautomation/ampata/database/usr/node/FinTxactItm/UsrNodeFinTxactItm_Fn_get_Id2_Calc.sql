drop function if exists Usr_Fin_Txact_Itm_Fn_get_Id2_Calc;

create function Usr_Fin_Txact_Itm_Fn_get_Id2_Calc(date1 date, i_x int, i_y int, i_z int) returns text
AS $$
...
plpy.debug(f"call Usr_Fin_Txact_Itm_Fn_get_Id2_Calc( date1:{date1}"
        +f", i_x:{i_x}, i_y:{i_y}, i_z:{i_z} "
        +f")"
        )
...
select 
	 Usr_Fin_Txact_Itm_Fn_get_Id2_Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,1,1,1) as id1
	,Usr_Fin_Txact_Itm_Fn_get_Id2_Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,1,1,null) as id2
	,Usr_Fin_Txact_Itm_Fn_get_Id2_Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,null,null,null) as id2
;
