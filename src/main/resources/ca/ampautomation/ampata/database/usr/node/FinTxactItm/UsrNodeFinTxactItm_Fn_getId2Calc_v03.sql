...
create function Fin_Txact_Itm_Fn_get_Id2_Calc(ts1 timestamp, i_x int, i_y int, i_z int) returns text
AS $$
...
select 
	 Fin_Txact_Itm_Fn_get_Id2_Calc(TO_TIMESTAMP('2021-01-01 04:05:06', 'YYYY-MM-DD HH24:MI:ss')::timestamp,1,1,1) as id1
	,Fin_Txact_Itm_Fn_get_Id2_Calc(TO_TIMESTAMP('2021-01-01 04:05:06', 'YYYY-MM-DD HH24:MI:ss')::timestamp,1,1,null) as id2
	,Fin_Txact_Itm_Fn_get_Id2_Calc(TO_TIMESTAMP('2021-01-01 04:05:06', 'YYYY-MM-DD HH24:MI:ss')::timestamp,null,null,null) as id2
;
