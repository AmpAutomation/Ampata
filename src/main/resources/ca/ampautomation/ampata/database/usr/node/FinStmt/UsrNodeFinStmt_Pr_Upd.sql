...
drop procedure if exists Usr_Fin_Stmt_Pr_Upd;

create procedure Usr_Fin_Stmt_Pr_Upd()
language 'plpgsql'
as $BODY$
declare
	rec_tenant record;
...
where class_name = 'UsrNodeFinStmt'
;	
...
update ampata_usr_node t
set id2_calc = Usr_Fin_Stmt_Fn_get_Id2_Calc(
		 t1.id2
		,t.id_dt_date1
		)
...
and	t.class_name = 'UsrNodeFinStmt'
;
...
from (
	...
	where t2a.class_name = 'UsrNodeFinStmt'
