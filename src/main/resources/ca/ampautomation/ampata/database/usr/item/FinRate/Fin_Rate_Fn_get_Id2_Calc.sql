drop function if exists Fin_Rate_Fn_get_Id2_Calc;

create function Fin_Rate_Fn_get_Id2_Calc(curcy1 text, curcy2 text, date1 date) returns text
LANGUAGE plpython3u
AS 
$body$
...
select * 
from (values
	 (Fin_Rate_Fn_get_Id2_Calc('USD','CAD','2021-01-01'::date))
	,(Fin_Rate_Fn_get_Id2_Calc('USD','CAD','2021-01-02'::date))

) as x(id2_calc)
UNION all
SELECT Fin_Rate_Fn_get_Id2_Calc('USD','','2021-01-01'::date) as id2_calc
UNION ALL
SELECT Fin_Rate_Fn_get_Id2_Calc('','CAD','2021-01-01'::date) as id2_calc
UNION ALL
SELECT Fin_Rate_Fn_get_Id2_Calc('USD','CAD',NULL) as id2_calc
;
