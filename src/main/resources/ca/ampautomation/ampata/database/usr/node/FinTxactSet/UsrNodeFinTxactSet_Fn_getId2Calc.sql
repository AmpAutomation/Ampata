drop function if exists UsrNodeFinTxactSet_Fn_getId2Calc;

create function UsrNodeFinTxactSet_Fn_getId2Calc(tst1 timestamp, i1 int) returns text
AS $$
...
select 
	 UsrNodeFinTxactSet_Fn_getId2Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,1) as id1
	,UsrNodeFinTxactSet_Fn_getId2Calc(TO_DATE('2021-01-01', 'YYYY-MM-DD')::date,null) as id2
;
